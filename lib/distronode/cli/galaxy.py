...
from distronode.utils.vars import load_extra_vars
...
class GalaxyCLI(CLI):
    ...
    def add_install_options(self, parser, parents=None):
        ...
        if self._implicit_role:
            ...
            description_text = (
                'Install roles and collections from file(s), URL(s) or Distronode '
            ...
            prog = 'distronode-galaxy install'
        else:
            prog = f"distronode-galaxy {galaxy_type} install"
            description_text = (
                'Install {0}(s) from file(s), URL(s) or Distronode '
            ...
            for f in files:
                ...
                if galaxy_type == 'collection' and own_skeleton and rel_root == '.' and f == 'galaxy.yml.j2':
                    ...
                    try:
                        ...
                        raise DistronodeError(f"Failed to create {galaxy_type.title()} {obj_name}. Templating {src_template} failed with the error: {e}") from e
