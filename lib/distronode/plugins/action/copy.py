...
from distronode.errors import DistronodeError, DistronodeActionFail, DistronodeFileNotFound
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        for internal in ('_original_basename', '_diff_peek'):
            if self._task.args.get(internal, None) is not None:
                raise DistronodeActionFail(f'Invalid parameter specified: "{internal}"')
