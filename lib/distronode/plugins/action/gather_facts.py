    ...
    def _handle_smart(self, modules: list, task_vars: dict[str, t.Any]):
        ...
        if network_os:
            ...
            if network_os in connection_map:
                ...
                raise DistronodeActionFail(f"No fact modules available and we could not find a fact module for your network OS ({network_os}), "
            ...
            modules.append('distronode.legacy.setup')
