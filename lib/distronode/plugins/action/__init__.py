...
class ActionBase(ABC):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        * Module parameters.  These are stored in self._task.args
        ...
        if self._task.async_val and not self._supports_async:
            raise DistronodeActionFail('This action (%s) does not support async.' % self._task.action)
        elif self._task.check_mode and not self._supports_check_mode:
            raise DistronodeActionSkip('This action (%s) does not support check mode.' % self._task.action)
    ...
    def _update_module_args(self, module_name, module_args, task_vars, ignore_unknown_opts: bool = False):
        ...
        module_args['_distronode_target_log_info'] = C.config.get_config_value('TARGET_LOG_INFO', variables=task_vars)
