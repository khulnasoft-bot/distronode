...
class ShellBase(DistronodePlugin):
    def __init__(self):
        ...
        # distronode.posix.fish uses (but does not actually use) this value.
        # https://github.com/distronode-collections/distronode.posix/blob/f41f08e9e3d3129e709e122540b5ae6bc19932be/plugins/shell/fish.py#L38-L39
        self.env = {}
        self.tmpdir = None
    ...
    def _generate_temp_dir_name():
        return 'distronode-tmp-%s-%s-%s' % (time.time(), os.getpid(), secrets.randbelow(2**48))
