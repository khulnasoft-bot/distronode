...
from distronode.parsing.vault import is_encrypted_file
...
def timedout(result):
    ...
    if not isinstance(result, MutableMapping):
        raise errors.DistronodeFilterError("The 'timedout' test expects a dictionary")
...
def vaulted_file(value):
    ...
    try:
        ...
        raise errors.DistronodeFilterError(f"Cannot test if the file {value} is a vault", orig_exc=e)
