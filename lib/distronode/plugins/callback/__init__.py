...
class CallbackBase(DistronodePlugin):
    ...
    def v2_runner_on_failed(self, result: TaskResult, ignore_errors: bool = False) -> None:
        ...
        Note: The value of 'ignore_errors' tells Distronode whether to
        continue running tasks on the host where this task failed.
        But the 'ignore_errors' directive only works when the task can
        run and returns a value of 'failed'. It does not make Distronode
        ...
        :param ignore_errors: Whether Distronode should continue \
