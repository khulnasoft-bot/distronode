...
- name: One way to avoid apt_key once it is removed from your distro
  block:
    ...
    - name: somerepo | apt source
      distronode.builtin.apt_repository:
        repo: "deb [arch=amd64 signed-by=/etc/apt/keyrings/somerepo.asc] https://download.example.com/linux/ubuntu {{ distronode_distribution_release }} stable"
        state: present
"""
...
from distronode.module_utils.common.file import S_IRWU_RG_RO as DEFAULT_SOURCES_PERM
