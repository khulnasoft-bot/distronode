...
options:
  async:
    description:
      ...
      - This parameter is deprecated as it has been removed on systems supported by distronode-core
        and will be removed in distronode-core 2.22.
    type: bool
  bandwidth:
    description:
  ...
  exclude:
    description:
      ...
      - O(excludepkgs) alias was added in distronode-core 2.18.
    type: list
    elements: str
    aliases:
      - excludepkgs
  ...
  keepcache:
    description:
      ...
      - This parameter is deprecated as it is only valid in the main configuration
        and will be removed in distronode-core 2.20.
    choices: ['0', '1']
    type: str
  metadata_expire:
    description:
...
from distronode.module_utils.basic import DistronodeModule, FILE_COMMON_ARGUMENTS
    ...
    def add(self):
        ...
        for key, value in sorted(self.params.items()):
            ...
            if key == 'keepcache':
                ...
                self.module.deprecate(
                    "'async' parameter is deprecated as it has been removed on systems supported by distronode-core",
                    version='2.22',
                )
            elif key in {
                "deltarpm_metadata_percentage",
