...
options:
    ...
    shell:
        description:
            ...
            - From Distronode 2.18, the type is changed to I(path) from I(str).
        type: path
    home:
        description:
    ...
    password:
        description:
            ...
            - When the password is passed as an argument, the M(distronode.builtin.user) module will always return changed to C(true) for macOS systems.
