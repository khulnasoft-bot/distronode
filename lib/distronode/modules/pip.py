...
options:
  ...
  state:
    description:
      - The state of module.
      - The V(forcereinstall) option is only available in Distronode 2.1 and above.
    type: str
  ...
  executable:
    description:
      ...
      - The C(setuptools) package must be installed for both the Distronode Python interpreter
