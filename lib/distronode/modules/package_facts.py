...
options:
  manager:
    description:
      ...
      - Aliases were added in 2.18, to support using C(manager={{distronode_facts['pkg_mgr']}})
    default: ['auto']
    choices:
...
from distronode.module_utils.facts.packages import CLIMgr, RespawningLibMgr, get_all_pkg_managers
