...
notes:
- This module will not automatically update caches, call the M(distronode.builtin.apt) module based
...
from distronode.module_utils.common.file import S_IRWXU_RXG_RXO, S_IRWU_RG_RO
