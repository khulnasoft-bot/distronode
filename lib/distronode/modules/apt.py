...
options:
  ...
  deb:
     description:
       ...
       - If C(://) in the path, distronode will attempt to download deb before installing. (Version added 2.1)
...
from distronode.module_utils.common.file import S_IRWXU_RXG_RXO
...
def main():
    ...
    if not HAS_PYTHON_APT:
        ...
        module.fail_json(
            ...
            f"or that you have specified the correct distronode_python_interpreter. (attempted {interpreters}).",
        )
