    ...
    def decorator(method):
        def wrapped(self, *args, **kwargs):
            ...
            if common_versions == {'v2'}:
                display.deprecated(
                    'The v2 Distronode Galaxy API is deprecated and no longer supported. '
                    'Ensure that you have configured the distronode-galaxy CLI to utilize an '
                    'updated and supported version of Distronode Galaxy.',
                    version='2.20'
                )
