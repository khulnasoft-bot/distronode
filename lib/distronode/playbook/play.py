...
from distronode.errors import DistronodeParserError, DistronodeAssertionError, DistronodeError
...
class Play(Base, Taggable, CollectionSearch):
    ...
    def _get_cached_role(self, role):
        ...
        try:
            ...
            raise DistronodeError(f'Cannot locate {role.get_name()} in role cache')
    ...
    def compile(self):
        ...
        t = Task()
        t.action = 'meta'
        t.resolved_action = 'distronode.builtin.meta'
