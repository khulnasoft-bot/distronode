...
from distronode.errors import DistronodeError, DistronodeParserError, DistronodeUndefinedVariable, DistronodeFileNotFound, DistronodeAssertionError
...
class VariableManager:
    ...
    def _get_magic_variables(self, play, host, task, include_hostvars, _hosts=None, _hosts_all=None):
        ...
        if play:
            ...
            # TODO: data tagging!!! DEPRECATED: role_names should be deprecated in favor of distronode_ prefixed ones
        ...
        if task.delegate_to:
            ...
            if delegated_host_name != self._omit_token:
                ...
                if not delegated_host_name:
                    raise DistronodeError('Empty hostname produced from delegate_to: "%s"' % task.delegate_to)
