...
Current()
{
    REQUIREMENTS_LINE=$(grep django-distronode-base $REQ_FILE)
...
Help()
{
   ...
   echo "Help:"
   echo ""
   echo "Interact with django-distronode-base in $REQ_FILE."
   echo "By default, output the current django-distronode-base pinned version."
   echo
   echo "Syntax: scriptTemplate [-s|h|v]"
   echo "options:"
   echo "s     Set django-distronode-base version to pin to."
