...
```
callback_receiver_batch_events_insert_db_bucket{le="10",node="api_1"} 1
callback_receiver_batch_events_insert_db_bucket{le="50",node="api_1"} 5
callback_receiver_batch_events_insert_db_bucket{le="150",node="api_1"} 5
callback_receiver_batch_events_insert_db_bucket{le="350",node="api_1"} 5
callback_receiver_batch_events_insert_db_bucket{le="650",node="api_1"} 5
callback_receiver_batch_events_insert_db_bucket{le="2000",node="api_1"} 5
callback_receiver_batch_events_insert_db_bucket{le="+Inf",node="api_1"} 5
callback_receiver_batch_events_insert_db_count{node="api_1"} 5
callback_receiver_batch_events_insert_db_sum{node="api_1"} 5
```
...
```
api_metrics_instance_api_1
api_metrics_instance_api_2
api_metrics_instance_api_3
```
