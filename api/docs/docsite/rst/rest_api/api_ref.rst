...
The API Reference Manual provides in-depth documentation for the API REST API, including integration examples.
...
.. raw:: html
    ...
    window.onload = function() {
      ...
      $('head').append('<link rel="stylesheet" href="../_static/api-rest-api.css" type="text/css"></link>');
