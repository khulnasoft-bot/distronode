...
https://github.com/AlanCoding/Distronode-inventory-file-examples/tree/master/issues/API371
...
plugin: constructed
strict: true
use_vars_plugins: true  # https://github.com/distronode/distronode/issues/75365
groups:
...
which runs via `distronode-inventory`.
