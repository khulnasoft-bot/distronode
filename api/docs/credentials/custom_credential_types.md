...
* SCM inventory sources can utilize a ``Credential``; you
  ...
  values in the Distronode inventory loading context (by - for example -
...
of the [Jinja templating language](https://jinja.palletsprojects.com/en/2.10.x/) (which should be familiar to users of Distronode):
