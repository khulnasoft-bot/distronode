...
setup(
    ...
    description='The official command line interface for Distronode API',
    author='Red Hat, Inc.',
    author_email='info@distronode.com',
    url='https://github.com/distronode/distronode/tree/devel/api',
    ...
    entry_points={'console_scripts': ['akit=apikit.scripts.basic_session:load_interactive', 'api=apikit.cli:run']},
    **extra_setup_args,
)
