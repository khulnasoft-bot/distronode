...
from apikit.utils import random_title


def upload_inventory(distronode_runner, nhosts=10, ini=False):
...
EOF''' % json_inventory(
    ...
    contacted = distronode_runner.copy(dest=copy_dest, force=True, mode=copy_mode, content=copy_content)
