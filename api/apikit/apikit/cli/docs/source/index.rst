.. API CLI documentation master file, created by
...
|prog| is the official command-line client for API and |RHAT|.  It:
...
* To the extent possible, auto-detects API versions, available endpoints, and
  feature support across multiple versions of API and |RHAT|.
