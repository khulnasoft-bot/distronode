...
from apikit import config, yaml_file
from apikit.exceptions import ImportExportError
from apikit.api.pages import Page
from apikit.api.pages.api import EXPORTABLE_RESOURCES
from apikit.cli.format import format_response, add_formatting_import_export
from apikit.cli.utils import CustomRegistryMeta
...
class Import(CustomCommand):
    ...
    def handle(self, client, parser):
        if parser:
            parser.usage = 'api import < exportfile'
...
class Export(CustomCommand):
    ...
    def handle(self, client, parser):
        ...
        parser.usage = 'api export > exportfile'
