...
from apikit.api.mixins import DSAdapter, HasCreate, HasCopy
from apikit.api.pages import (
    Credential,
    Organization,
)
from apikit.api.resources import resources
from apikit.utils import random_title, PseudoNamespace, filter_by_class
...
class ExecutionEnvironment(HasCreate, HasCopy, base.Base):
    ...
    def create(self, name='', image='quay.io/distronode/distronode/tree/devel/api-ee:latest', organization=Organization, credential=None, pull='', **kwargs):
