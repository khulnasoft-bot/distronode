...
from apikit.utils import args_string_to_list, seconds_since_date_string
from apikit.api.resources import resources
from apikit.api.mixins import HasStatus
...
class UnifiedJob(HasStatus, base.Base):
    ...
    def job_args(self):
        ...
        If you need to ensure the job_args are of api-provided format use raw unified_job.json.job_args.
        """
    ...
    def controller_dir(self):
        ...
        expected_prefix = '/tmp/api_{}'.format(self.id)
