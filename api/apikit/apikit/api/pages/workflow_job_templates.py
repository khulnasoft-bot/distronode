...
from apikit.api.mixins import HasCreate, HasNotifications, HasSurvey, HasCopy, DSAdapter
from apikit.api.pages import Organization, UnifiedJobTemplate
from apikit.utils import filter_by_class, not_provided, update_payload, random_title, PseudoNamespace
...
class WorkflowJobTemplate(HasCopy, HasCreate, HasNotifications, HasSurvey, UnifiedJobTemplate):
    ...
    def launch(self, payload={}):
        ...
        if jobs_pg.count != 1:
            ...
            raise exc.UnexpectedAPIState(msg)
