...
from apikit.api.mixins import DSAdapter, HasCopy, HasCreate
from apikit.api.pages import Organization, Team, User
from apikit.api.resources import resources
from apikit.config import config
from apikit.utils import (
    PseudoNamespace,
    cloud_types,
    filter_by_class,
    not_provided,
...
credential_type_name_to_config_kind_map = {
    ...
    'distronode galaxy/automation hub api token': 'galaxy',
    'red hat distronode automation platform': 'controller',
