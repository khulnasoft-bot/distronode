...
from apikit.utils import PseudoNamespace, is_relative_endpoint, are_same_endpoint, super_dir_set, is_list_or_tuple, to_str
from apikit.api import utils
from apikit.api.client import Connection
from apikit.api.registry import URLRegistry
...
def register_page(urls, page_cls):
    if not _page_registry.default:
        from apikit.api.pages import Base
