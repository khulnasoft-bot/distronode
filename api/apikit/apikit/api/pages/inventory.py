...
from apikit.api.pages import Credential, Organization, Project, UnifiedJob, UnifiedJobTemplate
from apikit.utils import filter_by_class, random_title, update_payload, not_provided, PseudoNamespace, poll_until
from apikit.api.mixins import DSAdapter, HasCreate, HasInstanceGroups, HasNotifications, HasVariables, HasCopy
from apikit.config import config
from apikit.api.resources import resources
import apikit.exceptions as exc
from . import base
from . import page
...
class Host(HasCreate, HasVariables, base.Base):
    ...
    def payload(self, inventory, **kwargs):
        ...
        if variables is None:
            variables = dict(distronode_host='localhost', distronode_connection='local', distronode_python_interpreter='{{ distronode_playbook_python }}')
