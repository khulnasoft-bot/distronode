...
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "api.settings.development")  # noqa
django.setup()  # noqa
...
# api
from api.main.models import (  # noqa
    Credential,
    CredentialType,
    Group,
    Host,
...
from api.main.signals import disable_activity_stream, disable_computed_fields  # noqa
...
bulk_data_description = 'From API bulk-data script'
                ...
                for i in range(n):
                    ...
                    project, _ = Project.objects.get_or_create(
                        ...
                        defaults=dict(
                            ...
                            scm_url='https://github.com/distronode/test-playbooks.git',
                            scm_type='git',
                            playbook_files=[
                                "check.yml",
                                "debug-50.yml",
            ...
            for n in spread(n_inventories, min(n_inventories // 4 + 1, n_organizations)):
                ...
                for i in range(n):
                    ...
                    inventory, _ = Inventory.objects.get_or_create(
                        ...
                        organization=org,
                        defaults=dict(created_by=next(creator_gen), modified_by=next(modifier_gen)),
                        variables='{"distronode_connection": "local"}',
                    )
