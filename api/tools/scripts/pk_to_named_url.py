...
def _get_named_url_graph(url, auth):
    """Get the graph data structure API used to manage all named URLs.

    Args:
        url: String representing the URL of tower configuration endpoint where
            to fetch graph information.
        auth: Tuple of username + password to authenticate connection to API.
...
def _get_named_url_identifier(url, named_url_graph, resource, tower_host, auth, ret):
    ...
    Args:
        ...
        tower_host: String representing the host name of API backend.
        auth: Tuple of username + password to authenticate connection to API.
...
def main(username=None, password=None, tower_host=None, resource=None, pk=None):
    ...
    Args:
        username: String representing the username needed to authenticating API.
        password: String representing the password needed to authenticating API.
        tower_host: String representing the host name of API backend.
