...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        license = self._task.args.get('api_license_type', None)
        ...
        headers = {
            ...
            'User-Agent': '{} {} ({})'.format('API' if license == 'open' else 'Red Hat Distronode Automation Platform', api_version, license),
        }
