...
from distronode_sign.checksum import (
    ChecksumFile,
    ChecksumMismatch,
    InvalidChecksumLine,
)
from distronode_sign.checksum.differ import DistlibManifestChecksumFileExistenceDiffer
from distronode_sign.signing import GPGVerifier
...
class ActionModule(ActionBase):
    ...
    def validate_gpg(self):
        ...
        signature_file = os.path.join(self.project_path, ".distronode-sign", "sha256sum.txt.sig")
        manifest_file = os.path.join(self.project_path, ".distronode-sign", "sha256sum.txt")
