...
STANDARD_INVENTORY_UPDATE_ENV = {
    ...
    # Always use the --export option for distronode-inventory
    'DISTRONODE_INVENTORY_EXPORT': 'True',
    # Redirecting output to stderr allows JSON parsing to still work with -vvv
    'DISTRONODE_VERBOSE_TO_STDERR': 'True',
    # if distronode-inventory --limit is used for an inventory import, unmatched should be a failure
    'DISTRONODE_HOST_PATTERN_MISMATCH': 'error',
}
...
LOGGER_BLOCKLIST = (
    'api.main.utils.handlers',
    'api.main.utils.formatters',
    'api.main.utils.filters',
    'api.main.utils.encryption',
    'api.main.utils.log',
...
RECEPTOR_PENDING = 'distronode-runner-???'

# Naming pattern for API jobs in /tmp folder, like /tmp/api_42_xiwm
# also update apikit.api.pages.unified_jobs if changed
JOB_FOLDER_PREFIX = 'api_%s_'
...
DISTRONODE_RUNNER_NEEDS_UPDATE_MESSAGE = (
    '\u001b[31m \u001b[1m This can be caused if the version of distronode-runner in your execution environment is out of date.\u001b[0m'
)
...
HOST_FACTS_FIELDS = ('name', 'distronode_facts', 'distronode_facts_modified', 'modified', 'inventory_id')
