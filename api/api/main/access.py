...
from distronode_base.lib.utils.validation import to_python_boolean
...
logger = logging.getLogger('api.main.access')
...
def vars_are_encrypted(vars):
    ...
    content which is encrypted by the API encryption algorithm
    """
