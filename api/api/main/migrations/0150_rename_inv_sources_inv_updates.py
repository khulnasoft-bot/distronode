...
from api.main.models.credential import ManagedCredentialType, CredentialType as ModernCredentialType
...
def forwards(apps, schema_editor):
    ...
    if tower_type is not None:
        ...
        logger.warning('Renaming the Distronode Tower credential type for existing install')
...
def backwards(apps, schema_editor):
    ...
    if tower_type is not None and not CredentialType.objects.filter(managed_by_tower=True, namespace='tower').exists():
        ...
        tower_type.name = 'Distronode Tower'
