...
from api.main.utils.common import set_current_apps
from api.main.utils.common import parse_yaml_or_json
...
def delete_custom_inv_source(apps, schema_editor):
    ...
    if ct:
        ...
        if src_ct:
            ...
            logger.warning('Custom inventory scripts have been removed, see api-manage export_custom_scripts')
