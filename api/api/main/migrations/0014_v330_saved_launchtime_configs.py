...
from api.main.migrations import _migration_utils as migration_utils
from api.main.migrations._multi_cred import migrate_workflow_cred, migrate_workflow_cred_reverse
from api.main.migrations._scan_jobs import remove_scan_type_nodes
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extra_data', api.main.fields.JSONBlob(blank=True, default=dict)),
                ('survey_passwords', api.main.fields.JSONBlob(blank=True, default=dict, editable=False)),
                ('char_prompts', api.main.fields.JSONBlob(blank=True, default=dict)),
        ...
        migrations.AddField(
            ...
            field=api.main.fields.AskForField(blank=True, default=False),
        ),
