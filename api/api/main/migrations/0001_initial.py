    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_data', api.main.fields.JSONBlob(default=dict, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', api.main.fields.AutoOneToOneField(related_name='profile', editable=False, on_delete=models.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Schedule',
            fields=[
                ...
                ('extra_data', api.main.fields.JSONBlob(default=dict, blank=True)),
                (
                    'created_by',
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job_env', api.main.fields.JSONBlob(default=dict, editable=False, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('survey_spec', api.main.fields.JSONBlob(default=dict, blank=True)),
            ],
            options={
                'ordering': ('name',),
            },
        ...
        migrations.AddField(
            model_name='inventorysource',
            name='group',
            field=api.main.fields.AutoOneToOneField(
