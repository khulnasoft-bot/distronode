...
from api.main.migrations._inventory_source import set_new_instance_id, back_out_new_instance_id


logger = logging.getLogger('api.main.migrations')


# new value introduced in api/settings/defaults.py, frozen in time here
