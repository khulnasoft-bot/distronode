...
# API
import api.main.fields
from api.main.models import Host
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='host_filter',
            field=api.main.fields.SmartFilterField(
        ...
        migrations.AddField(
            model_name='host',
            name='distronode_facts',
            field=models.JSONField(default=dict, help_text='Arbitrary JSON structure of most recent distronode_facts, per-host.', blank=True),
        ),
        migrations.AddField(
            model_name='host',
            name='distronode_facts_modified',
            field=models.DateTimeField(default=None, help_text='The date and time distronode_facts was last modified.', null=True, editable=False),
        ),
        migrations.AddField(
            model_name='job',
            name='use_fact_cache',
            field=models.BooleanField(
                default=False,
                help_text='If enabled, Tower will act as an Distronode Fact Cache Plugin; persisting facts at the end of a playbook run to the database and caching facts for use by Distronode.',
            ),
        ),
        migrations.AddField(
        ...
        dbawaremigrations.RunSQL(
            sql="CREATE INDEX host_distronode_facts_default_gin ON {} USING gin(distronode_facts jsonb_path_ops);".format(Host._meta.db_table),
            reverse_sql='DROP INDEX host_distronode_facts_default_gin;',
        ...
        migrations.AddField(
            ...
            field=api.main.fields.JSONBlob(
                default=list,
                help_text='Suggested list of content that could be Distronode inventory in the project',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'inputs',
                    api.main.fields.CredentialTypeInputField(
                        default=dict,
                        blank=True,
                        help_text='Enter inputs using either JSON or YAML syntax. Use the radio button to toggle between the two. Refer to the Distronode Tower documentation for example syntax.',
                    ),
                ),
                (
                    'injectors',
                    api.main.fields.CredentialTypeInjectorField(
                        default=dict,
                        blank=True,
                        help_text='Enter injectors using either JSON or YAML syntax. Use the radio button to toggle between the two. Refer to the Distronode Tower documentation for example syntax.',
                    ),
                ),
                (
                    'created_by',
        ...
        migrations.AddField(
            model_name='credential',
            name='inputs',
            field=api.main.fields.CredentialInputField(default=dict, blank=True),
        ),
        migrations.AddField(
            model_name='credential',
