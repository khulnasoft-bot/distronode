...
from api.main.utils import model_instance_diff, model_to_dict, camelcase_to_underscore, get_current_apps
from api.main.utils import ignore_inventory_computed_fields, ignore_inventory_group_removal, _inventory_updates
from api.main.tasks.system import update_inventory_computed_fields, handle_removed_image
...
from api.conf.utils import conf_to_dict

__all__ = []

logger = logging.getLogger('api.main.signals')
analytics_logger = logging.getLogger('api.analytics.activity_stream')
...
def model_serializer_mapping():
    ...
    from api.conf.serializers import SettingSerializer
...
def emit_activity_stream_change(instance):
    if 'migrate' in sys.argv:
        ...
        return
    from api.api.serializers import ActivityStreamSerializer
