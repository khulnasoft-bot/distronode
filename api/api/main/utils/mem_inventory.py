...
class MemHost(MemObject):
    ...
    def __init__(self, name, port=None):
        ...
        self.name = name
        if port:
            # was `distronode_ssh_port` in older Distronode versions
            self.variables['distronode_port'] = port
...
def mem_data_to_dict(inventory):
    ...
    follows Distronode guidelines on the structure of dynamic inventory sources
