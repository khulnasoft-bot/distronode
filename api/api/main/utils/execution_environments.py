...
def get_default_pod_spec():
    job_label: str = settings.API_CONTAINER_GROUP_DEFAULT_JOB_LABEL
    ...
    return {
        "apiVersion": "v1",
        "kind": "Pod",
        "metadata": {"namespace": settings.API_CONTAINER_GROUP_DEFAULT_NAMESPACE, "labels": {job_label: ""}},
        "spec": {
            ...
            "containers": [
                {
                    "image": ee.image,
                    "name": 'worker',
                    "args": ['distronode-runner', 'worker', '--private-data-dir=/runner'],
