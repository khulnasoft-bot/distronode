...
from api.main.utils import get_api_version, camelcase_to_underscore, datetime_hook
from api.main import models
from api.main.analytics import register
from api.main.scheduler.task_manager_models import TaskManagerModels

"""
This module is used to define metrics collected by api.main.analytics.gather()
...
def host_metric_slicing(key, since, until, last_gather, **kwargs):
    ...
    """
    from api.main.models.inventory import HostMetric
...
def unified_jobs_table(since, full_path, until, **kwargs):
    unified_job_query = '''COPY (SELECT main_unifiedjob.id,
                                 ...
                                 main_unifiedjob.distronode_version,
                                 main_job.forks
