# Copyright (c) 2022 Distronode by Red Hat
# All Rights Reserved.
import logging
...
class TaskManagerInstanceGroup:
    ...
    def __init__(self, obj, task_manager_instances=None, **kwargs):
        ...
        self.control_task_impact = kwargs.get('control_task_impact', settings.API_CONTROL_NODE_TASK_IMPACT)
...
class TaskManagerModels:
    def __init__(self, **kwargs):
        ...
        kwargs['control_task_impact'] = kwargs.get('control_task_impact', settings.API_CONTROL_NODE_TASK_IMPACT)
