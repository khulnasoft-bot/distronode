...
from api.main.models.base import CommonModel
from api.main.validators import validate_container_image_name
...
class ExecutionEnvironment(CommonModel):
    ...
    def validate_role_assignment(self, actor, role_definition, **kwargs):
        from api.main.models.credential import check_resource_server_for_user_in_organization
