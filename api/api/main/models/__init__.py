...
from distronode_base.lib.utils.models import user_summary_fields

# API
from api.main.models.base import BaseModel, PrimordialModel, accepts_json, VERBOSITY_CHOICES  # noqa
from api.main.models.unified_jobs import UnifiedJob, UnifiedJobTemplate, StdoutMaxBytesExceeded  # noqa
from api.main.models.organization import Organization, Team, UserSessionMembership  # noqa
from api.main.models.credential import Credential, CredentialType, CredentialInputSource, ManagedCredentialType, build_safe_env  # noqa
from api.main.models.projects import Project, ProjectUpdate  # noqa
from api.main.models.receptor_address import ReceptorAddress  # noqa
from api.main.models.inventory import (  # noqa
...
from api.main.models.jobs import (  # noqa
    Job,
    JobHostSummary,
    JobLaunchConfig,
    JobTemplate,
...
from api.main.models.events import (  # noqa
    AdHocCommandEvent,
...
from api.main.models.ad_hoc_commands import AdHocCommand  # noqa
from api.main.models.schedules import Schedule  # noqa
from api.main.models.execution_environments import ExecutionEnvironment  # noqa
from api.main.models.activity_stream import ActivityStream  # noqa
from api.main.models.ha import (  # noqa
    Instance,
    InstanceLink,
    InstanceGroup,
    TowerScheduleState,
)
from api.main.models.rbac import (  # noqa
    Role,
...
from api.main.models.mixins import (  # noqa
...
from api.main.models.notifications import Notification, NotificationTemplate, JobNotificationMixin  # noqa
from api.main.models.label import Label  # noqa
from api.main.models.workflow import (  # noqa
    WorkflowJob,
    WorkflowJobNode,
    WorkflowJobOptions,
    WorkflowJobTemplate,
...
from api.main.access import get_user_queryset, check_user_access, check_user_access_with_errors  # noqa


User.add_to_class('get_queryset', get_user_queryset)
User.add_to_class('can_access', check_user_access)
User.add_to_class('can_access_with_errors', check_user_access_with_errors)
User.add_to_class('resource', DistronodeResourceField(primary_key_field="id"))
    ...
    with connection.cursor() as cursor:
        for table, pkfield, columns in fields:
            ...
            if cursor.fetchone()[0]:
                from api.main.tasks.system import migrate_jsonfield
...
from api.main.registrar import activity_stream_registrar  # noqa
