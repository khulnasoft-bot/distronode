...
from api.main.models.base import CommonModelNameNotUnique, CreatedModifiedModel
from api.main.utils import encrypt_field, decrypt_field, set_environ
from api.main.notifications.email_backend import CustomEmailBackend
from api.main.notifications.slack_backend import SlackBackend
from api.main.notifications.twilio_backend import TwilioBackend
from api.main.notifications.pagerduty_backend import PagerDutyBackend
from api.main.notifications.webhook_backend import WebhookBackend
from api.main.notifications.mattermost_backend import MattermostBackend
from api.main.notifications.grafana_backend import GrafanaBackend
from api.main.notifications.rocketchat_backend import RocketChatBackend
from api.main.notifications.irc_backend import IrcBackend
from api.main.notifications.awssns_backend import AWSSNSBackend


logger = logging.getLogger('api.main.models.notifications')
...
class JobNotificationMixin(object):
 ...
 'created_by': 'admin'}""",
    ...
    def build_notification_message(self, nt, status):
        ...
        from api.api.serializers import UnifiedJobSerializer
        ...
        if len(body.strip().splitlines()) < 1:
            ...
            body = '\r\n'.join(
                [
                    ...
                    "Refer to https://github.com/distronode/distronode/tree/devel/api/issues/13983",
    ...
    def send_notification_templates(self, status):
        from api.main.tasks.system import send_notifications  # avoid circular import
