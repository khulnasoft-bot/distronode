...
# API
from api.main.utils import encrypt_field, parse_yaml_or_json
...
class BaseModel(models.Model):
    ...
    def summary_fields(self):
        """
        This exists for use by django-distronode-base,
        which has standard patterns that differ from API, but we enable views from DAB
        for those views to list summary_fields for API models, those models need to provide this
        """
        from api.api.serializers import SUMMARIZABLE_FK_FIELDS
