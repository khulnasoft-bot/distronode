...
from api.main.models.base import AD_HOC_JOB_TYPE_CHOICES, VERBOSITY_CHOICES, VarsDictProperty
from api.main.models.events import AdHocCommandEvent, UnpartitionedAdHocCommandEvent
from api.main.models.unified_jobs import UnifiedJob
from api.main.models.notifications import JobNotificationMixin, NotificationTemplate

logger = logging.getLogger('api.main.models.ad_hoc_commands')
...
class AdHocCommand(UnifiedJob, JobNotificationMixin):
    ...
    def _get_task_class(cls):
        from api.main.tasks.jobs import RunAdHocCommand
