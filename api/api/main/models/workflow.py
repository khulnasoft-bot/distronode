...
from api.main.models import accepts_json, UnifiedJobTemplate, UnifiedJob
from api.main.models.notifications import NotificationTemplate, JobNotificationMixin
from api.main.models.base import CreatedModifiedModel, VarsDictProperty
from api.main.models.rbac import ROLE_SINGLETON_SYSTEM_ADMINISTRATOR, ROLE_SINGLETON_SYSTEM_AUDITOR
from api.main.fields import ImplicitRoleField, JSONBlob, OrderedManyToManyField
...
from api.main.models.jobs import LaunchTimeConfigBase, LaunchTimeConfig, JobTemplate
from api.main.models.credential import Credential
from api.main.redact import REPLACE_STR
from api.main.utils import ScheduleWorkflowManager
...
logger = logging.getLogger('api.main.models.workflow')
...
class WorkflowJobNode(WorkflowNodeBase):
    ...
    def get_job_kwargs(self):
        ...
        if '_distronode_no_log' in aa_dict:
            for key in aa_dict:
                if key != '_distronode_no_log':
        ...
        if ujt_obj and isinstance(ujt_obj, (JobTemplate, WorkflowJobTemplate)):
            if aa_dict:
                ...
                functional_aa_dict.pop('_distronode_no_log', None)
