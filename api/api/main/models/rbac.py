...
# Distronode_base app
from distronode_base.rbac.models import RoleDefinition, RoleUserAssignment, RoleTeamAssignment
from distronode_base.lib.utils.models import get_type_for_model

# API
from api.api.versioning import reverse
from api.main.migrations._dab_rbac import build_role_map, get_permissions_for_role
from api.main.constants import role_name_to_perm_mapping, org_role_to_permission
...
logger = logging.getLogger('api.main.models.rbac')
...
def get_role_from_object_role(object_role):
    ...
    reverses naming from get_role_definition, and the DISTRONODE_BASE_ROLE_PRECREATE setting.
    """
...
def sync_parents_to_new_rbac(instance, action, model, pk_set, reverse, **kwargs):
    ...
    for role_id in pk_set:
        ...
        if parent_role.role_field == 'member_role' and parent_role.content_type.model == 'team':
            ...
            from api.main.models.organization import Team
