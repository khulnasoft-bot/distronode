...
logger = logging.getLogger('api.main.notifications.webhook_backend')


class WebhookBackend(APIBaseEmailBackend, CustomNotificationBase):
    MAX_RETRIES = 5
    ...
    def send_messages(self, messages):
        ...
        for m in messages:
            ...
            headers = {**(get_api_http_client_headers()), **(self.headers or {})}
