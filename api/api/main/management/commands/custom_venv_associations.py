# Copyright (c) 2021 Distronode, Inc.
# All Rights Reserved

from django.core.management.base import BaseCommand
from api.main.utils.common import get_custom_venv_choices
from api.main.models import Organization, InventorySource, JobTemplate, Project
import yaml
            ...
            if path[0] in all_venvs:  # verify this is a valid path
                ...
                if not options.get('q'):
                    msg = [
                        ...
                        'api-manage export_custom_venv /path/to/venv',
                        '',
