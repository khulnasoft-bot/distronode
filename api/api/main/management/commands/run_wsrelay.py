...
from api.main.analytics.broadcast_websocket import (
    RelayWebsocketStatsManager,
    safe_name,
)
from api.main.analytics.subsystem_metrics import WebsocketsMetricsServer
from api.main.wsrelay import WebSocketRelayManager


logger = logging.getLogger('api.main.wsrelay')
...
class Command(BaseCommand):
    ...
    def handle(self, *arg, **options):
        ...
        if migrating:
            logger.info('API is currently migrating, retry in 10s...')
            time.sleep(10)
            return
