...
from api.main.models import User, Organization, Project, Inventory, CredentialType, Credential, Host, JobTemplate
from api.main.signals import disable_computed_fields
            ...
            with disable_computed_fields():
                if not Organization.objects.exists():
                    ...
                    public_galaxy_credential, _ = Credential.objects.get_or_create(
                        ...
                        inputs={'url': 'https://galaxy.distronode.com/'},
                    )
