...
from api.main.dispatch.pool import AutoscalePool
from api.main.dispatch.worker import APIConsumerPG, TaskWorker
from api.main.analytics.subsystem_metrics import DispatcherMetricsServer
...
class Command(BaseCommand):
    ...
    def handle(self, *arg, **options):
        ...
        try:
            ...
            consumer = APIConsumerPG('dispatcher', TaskWorker(), queues, AutoscalePool(min_workers=4), schedule=settings.CELERYBEAT_SCHEDULE)
            consumer.run()
