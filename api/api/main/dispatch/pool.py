...
from api.main.utils.common import convert_mem_str_to_bytes, get_mem_effective_capacity
    ...
    def calculate_managed_tasks(self):
        ...
        for uuid in finished:
            try:
                ...
                # distronode _sometimes_ appears to send events w/ duplicate UUIDs;
                # UUIDs for distronode events are *not* actually globally unique
...
class WorkerPool(object):
    ...
    class MessagePrinter(api.main.dispatch.worker.BaseWorker):
