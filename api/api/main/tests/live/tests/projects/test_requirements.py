...
from api.main.tests.live.tests.conftest import wait_for_job

from api.main.models import Project, SystemJobTemplate
...
def test_cache_is_populated_after_cleanup_job(project_with_requirements):
    ...
    cache_path = os.path.join(settings.PROJECTS_ROOT, '.__api_cache')
