...
from api.api.urls import urlpatterns as api_patterns
...
def all_views():
    ...
    while unprocessed:
        ...
        for pattern in to_process:
            if hasattr(pattern, 'lookup_str') and not pattern.lookup_str.startswith('api.api'):
                continue
