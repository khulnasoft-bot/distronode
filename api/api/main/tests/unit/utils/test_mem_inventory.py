# API utils
from api.main.utils.mem_inventory import MemInventory, mem_data_to_dict, dict_to_mem_data
...
# https://docs.distronode.com/distronode/dev_guide/developing_inventory.html
@pytest.fixture
def JSON_with_lists():
    docs_example = '''{
       "databases"   : {
...
def test_ungrouped_mechanics():
    # distronode-inventory returns a group called `ungrouped`
