...
# API
from api.main.utils.filters import SmartFilter, ExternalLoggerEnabled
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({'enabled_flag': False}, 'api.main', False),
        # skip all records if the host is undefined
        ({'enabled_flag': True}, 'api.main', False),
        # skip all records if underlying logger is used by handlers themselves
        ({'enabled_flag': True}, 'api.main.utils.handlers', False),
        ({'enabled_flag': True, 'enabled_loggers': ['api']}, 'api.main', True),
        ({'enabled_flag': True, 'enabled_loggers': ['abc']}, 'api.analytics.xyz', False),
        ({'enabled_flag': True, 'enabled_loggers': ['xyz']}, 'api.analytics.xyz', True),
    ],
)
...
@mock.patch('api.main.utils.filters.get_model', return_value=mockHost())
class TestSmartFilterQueryFromString:
    @mock.patch(
        'distronode_base.rest_filters.rest_framework.field_lookup_backend.get_fields_from_path', lambda model, path, **kwargs: ([model], path)
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ('distronode_facts__a="true"', Q(**{u"distronode_facts__contains": {u"a": u"true"}})),
            ('distronode_facts__a__exact="true"', Q(**{u"distronode_facts__contains": {u"a": u"true"}})),
    ...
    @pytest.mark.parametrize(
        "filter_string",
        [
            'distronode_facts__facts__facts__blank=distronode_facts__a__b__c__ space  =ggg',
        ],
    )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (u'(distronode_facts__a=abc\u1F5E3def)', Q(**{u"distronode_facts__contains": {u"a": u"abc\u1F5E3def"}})),
        ],
    )
    ...
    @pytest.mark.parametrize(
        "filter_string,q_expected",
        [
            ('distronode_facts__a__b__c[]=3', Q(**{u"distronode_facts__contains": {u"a": {u"b": {u"c": [3]}}}})),
            ('distronode_facts__a__b__c[]=3.14', Q(**{u"distronode_facts__contains": {u"a": {u"b": {u"c": [3.14]}}}})),
            ('distronode_facts__a__b__c[]=true', Q(**{u"distronode_facts__contains": {u"a": {u"b": {u"c": [True]}}}})),
            ('distronode_facts__a__b__c[]=false', Q(**{u"distronode_facts__contains": {u"a": {u"b": {u"c": [False]}}}})),
            ('distronode_facts__a__b__c[]="true"', Q(**{u"distronode_facts__contains": {u"a": {u"b": {u"c": [u"true"]}}}})),
            ('distronode_facts__a__b__c[]="hello world"', Q(**{u"distronode_facts__contains": {u"a": {u"b": {u"c": [u"hello world"]}}}})),
            ('distronode_facts__a__b__c[]__d[]="foobar"', Q(**{u"distronode_facts__contains": {u"a": {u"b": {u"c": [{u"d": [u"foobar"]}]}}}})),
            ('distronode_facts__a__b__c[]__d="foobar"', Q(**{u"distronode_facts__contains": {u"a": {u"b": {u"c": [{u"d": u"foobar"}]}}}})),
            ('distronode_facts__a__b__c[]__d__e="foobar"', Q(**{u"distronode_facts__contains": {u"a": {u"b": {u"c": [{u"d": {u"e": u"foobar"}}]}}}})),
            ('distronode_facts__a__b__c[]__d__e[]="foobar"', Q(**{u"distronode_facts__contains": {u"a": {u"b": {u"c": [{u"d": {u"e": [u"foobar"]}}]}}}})),
            ('distronode_facts__a__b__c[]__d__e__f[]="foobar"', Q(**{u"distronode_facts__contains": {u"a": {u"b": {u"c": [{u"d": {u"e": {u"f": [u"foobar"]}}}]}}}})),
            (
                '(distronode_facts__a__b__c[]__d__e__f[]="foobar") and (distronode_facts__a__b__c[]__d__e[]="foobar")',
                Q(**{u"distronode_facts__contains": {u"a": {u"b": {u"c": [{u"d": {u"e": {u"f": [u"foobar"]}}}]}}}})
                & Q(**{u"distronode_facts__contains": {u"a": {u"b": {u"c": [{u"d": {u"e": [u"foobar"]}}]}}}}),
            ),
            # ('"a__b\"__c"="true"', Q(**{u"a__b\"__c": "true"})),
            # ('a__b\"__c="true"', Q(**{u"a__b\"__c": "true"})),
        ],
    ...
    @pytest.mark.parametrize(
        "filter_string,q_expected",
        [
            ('distronode_facts__a=null', Q(**{u"distronode_facts__contains": {u"a": None}})),
            ('distronode_facts__c="null"', Q(**{u"distronode_facts__contains": {u"c": u"\"null\""}})),
        ],
    )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                'search=foo or distronode_facts__a=null',
                Q(Q(**{u"name__icontains": u"foo"}) | Q(**{u"description__icontains": u"foo"})) | Q(**{u"distronode_facts__contains": {u"a": None}}),
            ),
        ],
    )
