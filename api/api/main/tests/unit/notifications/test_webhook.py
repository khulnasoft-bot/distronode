...
import api.main.notifications.webhook_backend as webhook_backend


def test_send_messages_as_POST():
    with mock.patch('api.main.notifications.webhook_backend.requests') as requests_mock, mock.patch(
        'api.main.notifications.webhook_backend.get_api_http_client_headers'
    ) as version_mock:
