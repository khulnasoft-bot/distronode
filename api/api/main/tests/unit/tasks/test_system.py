...
from api.main.models import Inventory
from django.db import DatabaseError


@pytest.fixture
def mock_logger():
    with patch("api.main.tasks.system.logger") as logger:
        yield logger
...
def test_update_inventory_computed_fields_existing_inventory(mock_logger, mock_inventory):
    ...
    with patch("api.main.tasks.system.Inventory.objects.filter") as mock_filter:
