...
from api.main.access import BaseAccess, check_superuser, JobTemplateAccess, WorkflowJobTemplateAccess, vars_are_encrypted
...
class TestWorkflowAccessMethods:
    ...
    def test_workflow_can_add(self, workflow, user_unit):
        ...
        with mock.patch('api.main.models.rbac.Role.__contains__', return_value=True):
            with mock.patch('api.main.access.get_object_or_400', mock_get_object):
