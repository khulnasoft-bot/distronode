...
from api.main.tests.URI import URI
...
uri = URI(scheme="https", username="myusername", password="mypasswordwith%40", host="nonexistant.distronode.com/distronode.git/")
TEST_CLEARTEXT.append(
    {
        ...
        stderr: fatal: unable to access '%s': Could not resolve host: nonexistant.distronode.com

        msg: fatal: unable to access '%s': Could not resolve host: nonexistant.distronode.com
