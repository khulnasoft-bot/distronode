...
from api.main.models import Job, WorkflowJobTemplateNode, WorkflowJob, WorkflowJobNode, WorkflowJobTemplate, Project, Inventory, JobTemplate


@pytest.mark.django_db
@mock.patch('api.api.serializers.UnifiedJobTemplateSerializer.get_related', lambda x, y: {})
...
@mock.patch('api.api.serializers.BaseSerializer.get_related', lambda x, y: {})
...
@pytest.mark.django_db
@mock.patch('api.api.serializers.BaseSerializer.validate', lambda self, attrs: attrs)
class TestWorkflowJobTemplateNodeSerializerSurveyPasswords:
    ...
    def test_use_db_answer(self, jt, mocker):
        ...
        mocker.patch('api.main.models.mixins.decrypt_value', return_value='foo')
...
@mock.patch('api.api.serializers.WorkflowJobTemplateNodeSerializer.get_related', lambda x, y: {})
