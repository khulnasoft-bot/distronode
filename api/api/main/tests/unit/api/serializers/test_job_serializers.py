...
# API
from api.api.serializers import JobSerializer, JobOptionsSerializer
...
@mock.patch('api.api.serializers.BaseSerializer.to_representation', lambda self, obj: {'extra_vars': obj.extra_vars})
...
@mock.patch('api.api.serializers.BaseSerializer.get_summary_fields', lambda x, y: {})
