...
def test_invalid_login():
    ...
    response = api.api.generics.LoggedLoginView.as_view()(request)
...
def test_invalid_post(mocker: MockerFixture, monkeypatch: pytest.MonkeyPatch):
    ...
    monkeypatch.setattr(api.api.generics, 'is_proxied_request', is_proxied_request_mock)
    response = api.api.generics.LoggedLoginView.as_view()(request)
