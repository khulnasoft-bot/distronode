...
from api.main.models import Instance, ReceptorAddress
from api.api.views.instance_install_bundle import generate_group_vars_all_yml
...
class TestPeers:
    ...
    def test_write_receptor_config_called(self):
        ...
        """
        with mock.patch('api.main.models.ha.schedule_write_receptor_config') as write_method:
    ...
    def test_write_receptor_config_data(self):
        ...
        """
        from api.main.tasks.receptor import RECEPTOR_CONFIG_STARTER

        with mock.patch('api.main.tasks.receptor.read_receptor_config', return_value=list(RECEPTOR_CONFIG_STARTER)):
            from api.main.tasks.receptor import generate_config_data
