...
from api.api.views.analytics import AnalyticsGenericView, MissingSettings, AUTOMATION_ANALYTICS_API_URL_PATH, ERROR_MISSING_USER, ERROR_MISSING_PASSWORD
...
class TestAnalyticsGenericView:
    ...
    def test__request_headers(self, existing_headers, expected_headers):
        ...
        expected_headers['X-Rh-Analytics-Source-Version'] = get_api_version()
