...
from distronode_base.lib.testing.fixtures import settings_override_mutable  # NOQA: F401 imported to be a pytest fixture
...
def test_validate_local_user(post, admin_user, settings, settings_override_mutable):  # NOQA: F811 this is how you use a pytest fixture
    "Copy of the test by same name in django-distronode-base for integration and compatibility testing"
    ...
    assert 'distronode_id' in response.data
...
def test_creating_user_retains_session(post, admin):
    ...
    '''
    with mock.patch('api.api.serializers.update_session_auth_hash') as update_session_auth_hash:
