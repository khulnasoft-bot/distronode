...
from api.main.management.commands.register_default_execution_environments import Command
...
def test_default_to_jobs_default(set_up_defaults, organization):
    ...
    ExecutionEnvironment.objects.create(name='Steves environment', image='quay.io/distronode/distronode/tree/devel/api-ee')
    ExecutionEnvironment(name=settings.GLOBAL_JOB_EXECUTION_ENVIRONMENTS[0]['name'], image='quay.io/distronode/distronode/tree/devel/api-ee', organization=organization)
...
def test_user_default(set_up_defaults):
    ...
    ee = ExecutionEnvironment.objects.create(name='Steves environment', image='quay.io/distronode/distronode/tree/devel/api-ee')
