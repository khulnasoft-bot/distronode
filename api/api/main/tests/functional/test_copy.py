...
from api.main.models.workflow import WorkflowJobTemplate, WorkflowJobTemplateNode, WorkflowApprovalTemplate
from api.main.models.jobs import JobTemplate
from api.main.tasks.system import deep_copy_model_obj
from api.main.models import Label, ExecutionEnvironment, InstanceGroup
...
def test_inventory_copy(inventory, group_factory, post, get, alice, organization):
    ...
    with mock.patch('api.api.generics.trigger_delayed_deep_copy') as deep_copy_mock:
