...
from api.main.migrations._dab_rbac import setup_managed_role_definitions

# API
from api.main.models.projects import Project
from api.main.models.ha import Instance, InstanceGroup
...
from api.main.models.credential import CredentialType, Credential
from api.main.models.jobs import JobTemplate, SystemJobTemplate
from api.main.models.inventory import Group, Inventory, InventoryUpdate, InventorySource
from api.main.models.organization import (
    Organization,
    Team,
)
from api.main.models.notifications import NotificationTemplate, Notification
from api.main.models.events import (
    JobEvent,
    AdHocCommandEvent,
    ProjectUpdateEvent,
...
from api.main.models.workflow import WorkflowJobTemplate
from api.main.models.ad_hoc_commands import AdHocCommand
from api.main.models.execution_environments import ExecutionEnvironment
...
dab_rr_initial = importlib.import_module('distronode_base.resource_registry.migrations.0001_initial')
...
def run_computed_fields_right_away(request):
    ...
    mocked = mock.patch('api.main.signals.update_inventory_computed_fields.delay', new=run_me)
    mocked.start()
...
def credentialtype_external():
    ...
    with mock.patch('api.main.models.credential.CredentialType.plugin', new_callable=PropertyMock) as mock_plugin:
...
def scm_inventory_source(inventory, project):
    ...
    with mock.patch('api.main.models.unified_jobs.UnifiedJobTemplate.update'):
        inv_src.save()
    return inv_src
...
def disable_database_settings(mocker):
    m = mocker.patch('api.conf.settings.SettingsWrapper.all_supported_settings', new_callable=PropertyMock)
    m.return_value = []
