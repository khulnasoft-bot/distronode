...
from api.main.models.inventory import Inventory, InventorySource
...
def test_custom_environment_injection(post, user, organization):
    ...
    with pytest.raises(ConnectionError), override_settings(API_TASK_ENV={'HTTPS_PROXY': '192.168.50.100:1234'}), mock.patch.object(
        HTTPAdapter, 'send'
    ) as fake_send:
