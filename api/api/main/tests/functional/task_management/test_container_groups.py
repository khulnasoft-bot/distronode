...
from api.main.scheduler import TaskManager
...
def test_kubectl_ssl_verification(containerized_job, default_job_execution_environment):
    ...
    openssl req -x509 -sha256 -new -nodes \
      -key {key} -subj '/C=US/ST=North Carolina/L=Durham/O=Distronode/OU=API Development/CN=api.localhost'
    """
    ...
    receptor_job = APIReceptorJob(rj, runner_params={'settings': {}})
