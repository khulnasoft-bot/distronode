...
from api.main.management.commands.provision_instance import Command
from api.main.models.ha import InstanceGroup, Instance
...
def test_register_self_openshift():
    ...
    with override_settings(API_AUTO_DEPROVISION_INSTANCES=True, CLUSTER_HOST_ID='foo_node', SYSTEM_UUID='12345'):
        Command().handle()
    inst = Instance.objects.first()
