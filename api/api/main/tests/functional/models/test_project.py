...
from api.main.models import Project, Credential, CredentialType
...
def test_galaxy_credentials(project):
    ...
    for i in range(5):
        cred = Credential.objects.create(
            name=f'Distronode Galaxy {i + 1}', organization=org, credential_type=galaxy, inputs={'url': 'https://galaxy.distronode.com/'}
        )
        cred.save()
