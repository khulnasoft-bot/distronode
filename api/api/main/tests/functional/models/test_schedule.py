...
from api.main.models import JobTemplate, Schedule, ActivityStream
...
class TestComputedFields:
    ...
    def test_computed_fields_time_change(self, job_template):
        ...
        with self.assert_no_unwanted_stuff(s):
            ...
            with mock.patch('api.main.models.schedules.emit_channel_notification'):
                s.update_computed_fields()
...
def test_really_old_dtstart(job_template, freq, delta):
    # see: https://github.com/distronode/distronode/tree/devel/api/issues/8071
...
@pytest.mark.django_db
@mock.patch('api.main.models.schedules.now', lambda: datetime(2030, 3, 5, tzinfo=pytz.utc))
