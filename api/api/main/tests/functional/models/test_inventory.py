...
# API
from api.main.models import Host, Inventory, InventorySource, InventoryUpdate, CredentialType, Credential, Job
...
class TestInventoryScript:
    ...
    def test_empty_group(self, inventory):
        ...
        data = inventory.get_script_data()
        # canonical behavior same as distronode-inventory
...
class TestInventorySourceInjectors:
    ...
    def test_plugin_filenames(self, source, filename):
        ...
        are named correctly, because Distronode will reject files that do
