...
from api.main.access import BaseAccess, JobTemplateAccess, ScheduleAccess
from api.main.models.jobs import JobTemplate
from api.main.models import Project, Organization, Schedule
...
class TestJobTemplateSchedules:
    ...
    def test_prompts_access_checked(self, job_template, inventory, credential, rando):
        ...
        with mock.patch('api.main.access.JobLaunchConfigAccess.can_add') as mock_add:
        ...
        with mock.patch('api.main.access.JobLaunchConfigAccess.can_change') as mock_change:
