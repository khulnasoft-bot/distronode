...
from api.main.access import UserAccess, RoleAccess, TeamAccess
from api.main.models import User, Organization, Inventory, get_system_auditor_role
...
def test_manage_org_auth_setting(ext_auth, superuser, expect, organization, rando, user, team):
    ...
    with mock.patch('api.main.access.settings') as settings_mock:
