...
def _get_read_only_distronode_cow_selection_default():
    return getattr(settings, 'DISTRONODE_COW_SELECTION', 'No default cow!')


register(
    'READONLY_DISTRONODE_COW_SELECTION',
    ...
    default=_get_read_only_distronode_cow_selection_default,
    ...
    depends_on=['DISTRONODE_COW_SELECTION'],
...
settings_registry.unregister('DISTRONODE_COW_SELECTION')
settings_registry.unregister('READONLY_DISTRONODE_COW_SELECTION')
