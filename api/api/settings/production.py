...
# Production settings for API project.
...
settings_dir = os.environ.get('API_SETTINGS_DIR', '/etc/tower/conf.d/')
...
settings_file = os.environ.get('API_SETTINGS_FILE', '/etc/tower/settings.py')
...
try:
    ...
    if not included_file or included_file == settings_file:
        ...
        if e and e.errno == errno.EACCES:
            ...
            msg = 'No API configuration found at %s.' % settings_file
            msg += '\nDefine the API_SETTINGS_FILE environment variable to '
