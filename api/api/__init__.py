...
def prepare_env():
    ...
    os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'api.settings.%s' % MODE)
...
def manage():
    ...
    # error message.  Allow --help to still work.
        ...
        sys.stdout.write('Permission denied: %s must be run as root or api.\n' % prog)
        sys.exit(1)
    else:
        execute_from_command_line(sys.argv)
