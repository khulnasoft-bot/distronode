...
from api.api.generics import LoggedLoginView, LoggedLogoutView
from api.api.views.root import (
    ApiRootView,
    ApiV2RootView,
    ApiV2PingView,
    ApiV2ConfigView,
...
from api.api.views.bulk import (
    BulkView,
    BulkHostCreateView,
    BulkHostDeleteView,
    BulkJobLaunchView,
...
from api.api.views.mesh_visualizer import MeshVisualizer

from api.api.views.metrics import MetricsView
from api.api.views.analytics import API_ANALYTICS_API_PREFIX
...
v2_urls = [
    ...
    re_path(r'^hosts/(?P<pk>[0-9]+)/distronode_facts/$', HostDistronodeFactsDetail.as_view(), name='host_distronode_facts_detail'),
    ...
    re_path(r'^settings/', include('api.conf.urls')),
    ...
    re_path(rf'^{API_ANALYTICS_API_PREFIX}/', include(analytics_urls)),
...
if MODE == 'development':
    ...
    from api.api.urls.debug import urls as debug_urls
