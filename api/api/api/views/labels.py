# API
from api.api.generics import SubListCreateAttachDetachAPIView, RetrieveUpdateAPIView, ListCreateAPIView
from api.main.models import Label
from api.api.serializers import LabelSerializer
