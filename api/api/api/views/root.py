# Copyright (c) 2018 Distronode, Inc.
# All Rights Reserved.
...
from api.api.generics import APIView
from api.conf.registry import settings_registry
from api.main.analytics import all_collectors
from api.main.ha import is_ha_environment
from api.main.utils import get_api_version, get_custom_venv_choices
from api.main.utils.licensing import validate_entitlement_manifest
from api.api.versioning import URLPathVersioning, reverse, drf_reverse
from api.main.constants import PRIVILEGE_ESCALATION_METHODS
from api.main.models import Project, Organization, Instance, InstanceGroup, JobTemplate
from api.main.utils import set_environ
from api.main.utils.licensing import get_licenser

logger = logging.getLogger('api.api.views.root')
...
class ApiRootView(APIView):
    ...
    def get(self, request, format=None):
        ...
        data = OrderedDict()
        data['description'] = _('API REST API')
...
class ApiV2PingView(APIView):
    ...
    def get(self, request, format=None):
        ...
        """
        response = {'ha': is_ha_environment(), 'version': get_api_version(), 'active_node': settings.CLUSTER_HOST_ID, 'install_uuid': settings.INSTALL_UUID}
