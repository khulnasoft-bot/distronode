...
Refer to [Dynamic Inventory](http://docs.distronode.com/intro_dynamic_inventory.html)
...
response format can be used with Distronode 1.3 and later to avoid making a
separate API request for each host.  Refer to
[Tuning the External Inventory Script](http://docs.distronode.com/developing_inventory.html#tuning-the-external-inventory-script)
