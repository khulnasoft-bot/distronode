...
# Copyright: (c) 2020, Distronode by Red Hat, Inc
...
options:
  ...
  verify_ssl:
    description:
    - Specify whether Distronode should verify the SSL certificate of the controller host.
  ...
  request_timeout:
    description:
    - Specify the timeout Distronode should use in requests to the controller host.
