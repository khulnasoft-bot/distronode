...
options:
    ...
    credential_type:
      description:
        ...
        - Choices include Amazon Web Services, Distronode Galaxy/Automation Hub API Token, Centrify Vault Credential Provider Lookup,
          ...
          Bearer Token, OpenStack, Red Hat Distronode Automation Platform, Red Hat Satellite 6, Red Hat Virtualization, Source Control,
...
- name: Add Credential with Custom Credential Type
  credential:
    ...
    controller_password: distronode
