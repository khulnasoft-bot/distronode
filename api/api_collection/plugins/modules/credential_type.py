...
DISTRONODE_METADATA = {'status': ['preview'], 'supported_by': 'community', 'metadata_version': '1.1'}
    ...
    kind:
      description:
        - >-
          ...
          net can be used for creating credential types. Refer to the Distronode
...
KIND_CHOICES = {'ssh': 'Machine', 'vault': 'Distronode Vault', 'net': 'Network', 'scm': 'Source Control', 'cloud': 'Lots of others', 'insights': 'Insights'}
