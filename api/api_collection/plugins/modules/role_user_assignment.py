...
def main():
    ...
    argument_spec = dict(
        ...
        object_distronode_id=dict(required=False, type='int'),
        user_distronode_id=dict(required=False, type='int'),
    ...
    object_distronode_id = module.params.get('object_distronode_id')
    user_distronode_id = module.params.get('user_distronode_id')
    ...
    kwargs = {
        ...
        'object_id': object_id,
        'user': user['id'],
        'object_distronode_id': object_distronode_id,
        'user_distronode_id': user_distronode_id,
    }
