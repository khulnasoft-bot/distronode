...
options:
    ...
    galaxy_credentials:
      description:
        - list of Distronode Galaxy credential names, IDs, or named URLs to associate to the organization
      type: list
      elements: str
...
- name: Create organization that pulls content from galaxy.distronode.com
  organization:
    name: "Foo"
    state: present
    galaxy_credentials:
