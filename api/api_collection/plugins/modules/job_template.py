...
options:
    ...
    organization:
      description:
        ...
        - Requires Automation Platform Version 3.7.0 or API 10.0.0 IS NOT backwards compatible with earlier versions.
      type: str
    project:
      description:
    ...
    custom_virtualenv:
      description:
        ...
        - Only compatible with older versions of API/Tower
    ...
    verbosity:
      description:
        - Control the output level Distronode produces as the playbook runs. 0 - Normal, 1 - Verbose, 2 - More Verbose, 3 - Debug, 4 - Connection Debug.
      choices: [0, 1, 2, 3, 4, 5]
      type: int
    extra_vars:
      description:
...
notes:
  - JSON for survey_spec can be found in the API Documentation. See
    U(https://docs.distronode.com/automation-controller/latest/html/towerapi)
