...
from api.main.models import WorkflowJobTemplateNode, WorkflowJobTemplate, JobTemplate, UnifiedJobTemplate
...
pytestmark = pytest.mark.filterwarnings(
    ...
    # Ref: https://github.com/distronode/distronode/tree/devel/api/pull/15620
