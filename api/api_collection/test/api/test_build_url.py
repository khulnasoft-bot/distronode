...
@pytest.mark.parametrize(
    ...
    [
        ...
        ["api", None, "https://localhost:8043", None, "jobs", "https://localhost:8043/api/v2/jobs/"],
        ["api", None, "https://localhost:8043", None, "jobs/209", "https://localhost:8043/api/v2/jobs/209/"],
        ["api", None, "https://localhost:8043", None, "organizations", "https://localhost:8043/api/v2/organizations/"],
        ["api", None, "https://localhost", "controller", "jobs", "https://localhost/api/controller/v2/jobs/"],
        ["api", None, "https://localhost", "controller", "jobs/1", "https://localhost/api/controller/v2/jobs/1/"],
        ["api", None, "https://localhost", "gateway", "tokens", "https://localhost/api/gateway/v1/tokens/"],
        ["api", None, "https://localhost", "gateway", "tokens/199", "https://localhost/api/gateway/v1/tokens/199/"],
        ...
        ["api", "api/controller", "https://localhost", None, "jobs", "https://localhost/api/controller/v2/jobs/"],
        ["api", "api/controller", "https://localhost", None, "jobs/209", "https://localhost/api/controller/v2/jobs/209/"],
        ["api", "api/controller", "https://localhost", None, "organizations", "https://localhost/api/controller/v2/organizations/"],
        ["api", "api/controller", "https://localhost", "controller", "jobs", "https://localhost/api/controller/v2/jobs/"],
        ["api", "api/controller", "https://localhost", "controller", "jobs/1", "https://localhost/api/controller/v2/jobs/1/"],
        ["api", "api/controller", "https://localhost", "gateway", "tokens", "https://localhost/api/gateway/v1/tokens/"],
        ["api", "api/controller", "https://localhost", "gateway", "tokens/199", "https://localhost/api/gateway/v1/tokens/199/"],
