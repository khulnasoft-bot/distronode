...
from api.main.models import Organization, Inventory, Group, Host
...
def test_create_group(run_module, admin_user):
    ...
    variables = {"distronode_network_os": "iosxr"}
    ...
    assert group.variables == '{"distronode_network_os": "iosxr"}'
...
def test_group_idempotent(run_module, admin_user):
    # https://github.com/distronode/distronode/issues/46803
    org = Organization.objects.create(name='test-org')
    inv = Inventory.objects.create(name='test-inv', organization=org)
