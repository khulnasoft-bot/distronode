...
from api.main.models import JobTemplate, Schedule
from api.api.serializers import SchedulePreviewSerializer
...
def test_rrule_lookup_plugin(collection_import, freq, kwargs, expect):
    ...
    # Try to run our generated rrule through the api validator
