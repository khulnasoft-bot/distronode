...
Use the GitHub [issue tracker](https://github.com/distronode/distronode/tree/devel/api/issues) for filing bugs. In order to save time, and help us respond to issues quickly, make sure to fill out as much of the issue template
as possible. Version information, and an accurate reproducing scenario are critical to helping us identify the problem.

Please don't use the issue tracker as a way to ask how to do something. Instead, use the [Distronode Forum](https://forum.distronode.com/tag/api).
...
### API Issue Bot (apibot)
We use an issue bot to help us label and organize incoming issues, this bot, apibot, is a version of [distronode/ansibullbot](https://github.com/distronode/ansibullbot).

#### Overview

APIbot performs many functions:
...
Currently you can expect apibot to add common labels such as `state:needs_triage`, `type:bug`, `component:docs`, etc...
These labels are determined by the template data. Please use the template and fill it out as accurately as possible.
