...
Function Get-DistronodeWindowsWebRequest {
    <#
    .SYNOPSIS
    ...
    Invoke-DistronodeWindowsWebRequest.
    ...
    $web_request = Get-DistronodeWindowsWebRequest -Module $module
    #>
    [CmdletBinding()]
    ...
    if ($web_request -is [System.Net.HttpWebRequest]) {
        ...
        if ($Headers -and $Headers.ContainsKey("User-Agent")) {
            $options = (Get-DistronodeWindowsWebRequestSpec).options
...
Function Invoke-DistronodeWindowsWebRequest {
    <#
    .SYNOPSIS
    ...
    Get-DistronodeWindowsWebRequest.
    ...
    Invoke-DistronodeWindowsWebRequest -Module $module -Request $web_request -Script {
        Param ([System.Net.WebResponse]$Response, [System.IO.Stream]$Stream)
...
Function Get-DistronodeWindowsWebRequestSpec {
    <#
    .SYNOPSIS
    ...
    .NOTES
    The options here are reflected in the doc fragment 'distronode.windows.web_request' at
...
$export_members = @{
    Function = "Get-DistronodeWindowsWebRequest", "Get-DistronodeWindowsWebRequestSpec", "Invoke-DistronodeWindowsWebRequest"
}
