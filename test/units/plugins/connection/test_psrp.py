...
class TestConnectionPSRP(object):
    ...
    OPTIONS_DATA: tuple[tuple[dict[str, t.Any], dict[str, t.Any]], ...] = (
        ...
        # psrp extras
        (
            {'distronode_psrp_mock_test1': True},
            {
                '_psrp_conn_kwargs': {
                    'server': 'inventory_hostname',
                    'port': 5986,
        ...
        (
            {'distronode_psrp_cert_trust_path': '/path/cert.pem'},
            {
        ...
        (
            {'distronode_psrp_ignore_proxy': 'true'},
            {
        ...
        (
            {'distronode_psrp_ignore_proxy': 'n'},
            {
        ...
        (
            {'distronode_psrp_ignore_proxy': 'y'},
            {
                '_psrp_conn_kwargs': {'no_proxy': True},
            }
        ),
