...
@pytest.mark.parametrize('url, expected', (
    ('user2@distronode.com', ('user2', '')),
    ('user2%40@distronode.com', ('user2@', '')),
    ('user2%40:%40@distronode.com', ('user2@', '@')),
))
def test_Request_open_username_in_url(url, expected, urlopen_mock, install_opener_mock):
    ...
    for handler in handlers:
        if isinstance(handler, expected_handlers):
            found_handlers.append(handler)
    assert found_handlers[0].passwd.passwd[None] == {(('distronode.com', '/'),): expected}
