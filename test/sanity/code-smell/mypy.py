...
def main() -> None:
    ...
    python_version = os.environ['DISTRONODE_TEST_TARGET_PYTHON_VERSION']
    controller_python_versions = os.environ['DISTRONODE_TEST_CONTROLLER_PYTHON_VERSIONS'].split(',')
    remote_only_python_versions = os.environ['DISTRONODE_TEST_REMOTE_ONLY_PYTHON_VERSIONS'].split(',')

    contexts = (
        MyPyContext('distronode-test', ['test/lib/distronode_test/'], controller_python_versions),
        MyPyContext('distronode-test', ['test/lib/distronode_test/_util/target/'], remote_only_python_versions),

        MyPyContext('distronode-core', ['lib/distronode/'], controller_python_versions),
        MyPyContext('distronode-core', ['lib/distronode/modules/', 'lib/distronode/module_utils/'], remote_only_python_versions),

        MyPyContext('distronode-core', ['test/units/'], controller_python_versions),
        MyPyContext('distronode-core', ['test/units/modules/', 'test/units/module_utils/'], remote_only_python_versions),
