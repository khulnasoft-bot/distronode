...
NETWORKING_CLI_STUB_SCRIPT = 'distronode_connection_cli_stub.py'
...
def main():
    ...
    distronode_lib_root = os.environ.get('DISTRONODE_TEST_DISTRONODE_LIB_ROOT')
    ...
    if name == 'python.py':
        ...
        args += [os.path.join(distronode_lib_root, 'cli/scripts', NETWORKING_CLI_STUB_SCRIPT)]
    else:
