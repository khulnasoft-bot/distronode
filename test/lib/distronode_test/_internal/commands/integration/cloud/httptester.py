...
class HttptesterProvider(CloudProvider):
    ...
    def __init__(self, args: IntegrationConfig) -> None:
        ...
        self.image = os.environ.get('DISTRONODE_HTTP_TEST_CONTAINER', 'quay.io/distronode/http-test-container:3.3.0')
    ...
    def setup(self) -> None:
        ...
        aliases = [
            'distronode.http.tests',
            'sni1.distronode.http.tests',
            'fail.distronode.http.tests',
            'self-signed.distronode.http.tests',
        ]
