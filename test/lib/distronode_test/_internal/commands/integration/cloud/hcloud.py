...
class HcloudCloudProvider(CloudProvider):
    ...
    def _setup_dynamic(self) -> None:
        """Request Hetzner credentials through the Distronode Core CI service."""
    ...
    def _create_distronode_core_ci(self) -> DistronodeCoreCI:
        """Return a Hetzner instance of DistronodeCoreCI."""
        return DistronodeCoreCI(self.args, CloudResource(platform='hetzner'))
...
class HcloudCloudEnvironment(CloudEnvironment):
    ...
    def get_environment_config(self) -> CloudEnvironmentConfig:
        ...
        distronode_vars.update(dict((key.lower(), value) for key, value in env_vars.items()))
