...
class NiosProvider(CloudProvider):
    ...
    # https://github.com/distronode/nios-test-container
    DOCKER_IMAGE = 'quay.io/distronode/nios-test-container:7.0.0'

    def __init__(self, args: IntegrationConfig) -> None:
        super().__init__(args)

        self.__container_from_env = os.environ.get('DISTRONODE_NIOSSIM_CONTAINER')
        """
        Overrides target container, might be used for development.

        Use DISTRONODE_NIOSSIM_CONTAINER=whatever_you_want if you want
