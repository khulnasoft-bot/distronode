...
class HostConfig(metaclass=abc.ABCMeta):
    ...
    def is_managed(self) -> bool:
        ...
        Managed instances are used exclusively by distronode-test and can safely have destructive operations performed without explicit permission from the user.
        """
        return False
...
class PythonConfig(metaclass=abc.ABCMeta):
    ...
    def is_managed(self) -> bool:
        ...
        Managed instances are used exclusively by distronode-test and can safely have requirements installed without explicit permission from the user.
        """
