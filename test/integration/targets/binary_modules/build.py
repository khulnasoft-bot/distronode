...
https://ci-files.testing.distronode.com/test/integration/roles/test_binary_modules/
...
def main() -> None:
    ...
    # NOTE: The value of `NAME` must be `distronode_architecture` for the target system, plus any required extension.
    builds = (
