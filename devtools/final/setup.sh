...
# gcc: for distronode-pylibssh, onigurumacffi/arm64
# ncurses: for distronode-navigator
...
for dir in \
    /tmp/dist \
    /home/runner \
    /home/runner/.distronode \
    /home/runner/.distronode/tmp \
    /runner \
    /home/runner \
    /runner/env \
    /runner/inventory \
...
for file in /home/runner/.distronode/galaxy_token /etc/passwd /etc/group; do
    touch $file
    chmod g+rw $file
    chgrp root $file;
done
...
mkdir -p ~/.distronode/roles /usr/share/distronode/roles /etc/distronode/roles
