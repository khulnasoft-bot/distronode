...
import distronode_devtools  # noqa: F401

from distronode_devtools.subcommands.server import Server
...
class Infrastructure:
    ...
    Attributes:
        ...
        navigator_ee: The image to use with distronode navigator
    """
...
def get_nav_default_ee_in_container() -> str:
    ...
    """
    cmd = (
        'python3 -c "from distronode_navigator.utils.packaged_data import ImageEntry;'
        'print(ImageEntry.DEFAULT_EE.get(app_name=\\"distronode_navigator\\"))"'
    )
