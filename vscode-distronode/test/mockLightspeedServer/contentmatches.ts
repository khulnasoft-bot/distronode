  ...
  contentmatches: [
    {
      contentmatch: [
        {
          repo_name: "fuchscs.distronode_bible",
          repo_url:
            "https://galaxy.distronode.com/ui/standalone/roles/fuchscs/distronode_bible",
          path: "roles/copy/tasks/main.yml",
          license: "GPL",
          data_source_description: "Distronode Galaxy roles",
          score: 0.92848563,
        },
        {
          repo_name: "narsingdev.apache_role",
          repo_url:
            "https://galaxy.distronode.com/ui/standalone/roles/narsingdev/apache_role",
          path: "tasks/main.yml",
          license: "GPL",
          data_source_description: "Distronode Galaxy roles",
          score: 0.9281237,
        },
        {
          ...
          repo_url:
            "https://galaxy.distronode.com/ui/standalone/roles/buluma/maintenance",
...
export function contentmatches(_req: {
  ...
  return suggestions[0].includes("distronode.builtin.file")
    ? RESPONSE_DATA
    : NO_MATCHES;
}
