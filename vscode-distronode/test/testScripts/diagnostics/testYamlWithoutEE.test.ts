...
export function testDiagnosticsYAMLWithoutEE(): void {
  describe("TEST FOR YAML DIAGNOSTICS WITHOUT EE", () => {
    ...
    describe("YAML diagnostics in the presence of distronode-lint", () => {
      it("should provide diagnostics with YAML validation (with distronode-lint)", async () => {
    ...
    describe("YAML diagnostics in the absence of distronode-lint", () => {
      before(async () => {
