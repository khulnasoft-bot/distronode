...
export function testHoverEE(): void {
  describe("TEST FOR HOVER (WITH EE)", () => {
    ...
    describe("Hover for module name and options present in the EE", () => {
      it("should hover over collection module name present in EE (distronode.posix.patch)", async () => {
      ...
      it("should hover over collection module option present in EE (distronode.posix.patch -> src)", async () => {
      ...
      it("should hover over collection module option present in EE (distronode.posix.patch -> dest)", async () => {
