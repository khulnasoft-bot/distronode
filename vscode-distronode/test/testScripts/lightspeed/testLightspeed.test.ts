  ...
  const tests = [
    {
      ...
      expectedModule: "distronode.builtin.debug",
    },
  ];
...
function testSuggestionExpectedInsertTexts() {
  ...
  const insertTexts = [
    `  ${LIGHTSPEED_SUGGESTION_GHOST_TEXT_COMMENT}      distronode.builtin.debug:\n        msg: Hello World\n    `,
  ];
  ...
  const tests = [
    {
      ...
      expectedModule: "distronode.builtin.package",
    },
  ];
...
export function testLightspeed(): void {
  describe("TEST DISTRONODE LIGHTSPEED", function () {
    ...
    describe("Test Distronode Lightspeed inline completion suggestions", function () {
    ...
    describe("Test Distronode Lightspeed multitask inline completion suggestions", function () {
      const docUri1 = getDocUri("lightspeed/playbook_1.yml");
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    describe.skip("Test Distronode Lightspeed inline completion suggestions with keeping typing", function () {
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      let feedbackRequestSpy: any;
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    describe("Test Distronode prompt not triggered", function () {
      const docUri1 = getDocUri("lightspeed/playbook_1.yml");
    ...
    describe("Test Distronode Lightspeed inline completion suggestions with Jinja brackets", function () {
    ...
    describe("Test Distronode Lightspeed Functions", function () {
