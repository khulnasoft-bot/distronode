...
function createMatchResponse(): ContentMatchesResponseParams {
  const contentMatchParams = {
    repo_name: "distronode.distronode",
    repo_url: "https://github.com/distronode/distronode",
    path: "some/file.py",
    license: "GPLv3+",
    data_source_description: "distronode-core repository",
    score: 123,
...
describe("GetWebviewContent", () => {
  ...
  it("suggestion with a match", async function () {
    ...
    assert.match(res, new RegExp("<summary>distronode.distronode</summary>"));
