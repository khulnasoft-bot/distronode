...
const getBinDetailTests = [
  ...
  {
    name: "valid binary (distronode-lint)",
    command: "distronode-lint",
    arg: "--version",
    expected: "distronode-lint",
  },
  {
    name: "invalid binary (distronode-invalid)",
    command: "distronode-invalid",
    arg: "--version",
    expected: "failed",
  },
  {
    name: "valid binary (distronode-creator)",
    command: "distronode-creator",
    arg: "--version",
    expected: "distronode-creator",
  },
];
