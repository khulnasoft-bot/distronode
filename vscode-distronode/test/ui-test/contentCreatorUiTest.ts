...
describe("Test Distronode playbook and collection project scaffolding", () => {
  ...
  it("Check create-distronode-project webview elements", async () => {
    await testWebViewElements(
      "Distronode: Create New Playbook Project",
  ...
  it("Check create-distronode-collection webview elements", async () => {
    await testWebViewElements(
      "Distronode: Create New Collection",
...
describe("Test Distronode sample execution environment file scaffolding", () => {
  let createEEButton: WebElement;
  let editorView: EditorView;
  let output: WebElement;

  before(async () => {
    // Install distronode-creator
    await workbenchExecuteCommand("Install Distronode Content Creator");
    await sleep(2000);
  });
  ...
  it("Check create-sample-execution-env-file webview elements", async () => {
    await testWebViewElements(
      "Distronode: Create a sample Distronode Execution Environment file",
