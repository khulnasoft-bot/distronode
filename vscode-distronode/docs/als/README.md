...
This language server adds support for Distronode and is currently used by the
following projects:

- [Distronode extension for vscode/codium](https://github.com/distronode/distronode/tree/devel/vscode-distronode)
- [Distronode extension for vim and neovim](https://github.com/yaegassy/coc-distronode)
- [Distronode client for Emacs LSP](https://emacs-lsp.github.io/lsp-mode/page/lsp-distronode/)

Releases are published to
[npmjs registry](https://www.npmjs.com/package/@distronode/distronode-language-server).

## Features

### Syntax highlighting

![Syntax highlighting](https://github.com/distronode/distronode-language-server/raw/main/docs/images/syntax-highlighting.png)
...
![YAML validation](https://github.com/distronode/distronode-language-server/raw/main/docs/images/yaml-validation.gif)
...
![Linter support](https://github.com/distronode/distronode-language-server/raw/main/docs/images/distronode-lint.gif)
...
[Distronode Lint Documentation](https://distronode-lint.readthedocs.io/en/latest/configuring.html))
are shown as warnings instead.

> If you also install `yamllint`, `distronode-lint` will detect it and incorporate
> into the linting process. Any findings reported by `yamllint` will be exposed
> in VSCode as errors/warnings.

**_Note_**

If `distronode-lint` is not installed/found or running `distronode-lint` results in
errors, it will fall back to `distronode --syntax-check` for validation.

### Smart auto-completion

![Autocompletion](https://github.com/distronode/distronode-language-server/raw/main/docs/images/smart-completions.gif)
...
[`collections` keyword]:
  https://docs.distronode.com/distronode/latest/collections_guide/collections_using_playbooks.html#simplifying-module-names-with-the-collections-keyword

#### Auto-closing Jinja expressions

![Easier Jinja expression typing](https://github.com/distronode/distronode-language-server/raw/main/docs/images/jinja-expression.gif)
...
![Documentation on hover](https://github.com/distronode/distronode-language-server/raw/main/docs/images/hover-documentation-module.png)
...
![Go to code on Ctrl+click](https://github.com/distronode/distronode-language-server/raw/main/docs/images/go-to-definition.gif)
...
For standalone usage with a language-server client, the Distronode language server
can be installed from npm with the following command:

```bash
npm install -g @distronode/distronode-language-server
```

## Language Server Settings

For details on settings, their descriptions and their default values refer to
[settings](https://distronode.readthedocs.io/projects/vscode-distronode/als/settings/).
...
[development document]:
  https://github.com/distronode/distronode-language-server/blob/main/docs/development.md
...
- Only Jinja _expressions_ inside Distronode YAML files are supported. To do syntax
