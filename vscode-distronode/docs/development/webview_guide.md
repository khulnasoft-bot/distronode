...
vscode-distronode extension. This might differ from the implementation for other
extensions.
...
1.  **Local resources:** The extension has already implemented some webviews.
    ...
    - extension context file:
      [createDistronodeProjectPage.ts](https://github.com/distronode/distronode/tree/devel/vscode-distronode/blob/main/src/features/contentCreator/createDistronodeProjectPage.ts)

    - webview context file:
      [createDistronodeProjectPageApp.ts](https://github.com/distronode/distronode/tree/devel/vscode-distronode/blob/main/src/webview/apps/contentCreator/createDistronodeProjectPageApp.ts)

    - webpack config file:
      [webpack.config.ts](https://github.com/distronode/distronode/tree/devel/vscode-distronode/blob/main/webpack.config.ts)
