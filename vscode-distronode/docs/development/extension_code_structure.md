...
Besides providing language services for Distronode, the extension hosts various
Distronode development tools and features. Implementations of these features are in
this sub-folder.
...
A lot of Distronode developer tools are implemented as web-views in the extension.
