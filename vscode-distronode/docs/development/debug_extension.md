...
Fork and clone the vscode-distronode repository into your local environment. Set
...
it again after navigating to the packages/distronode-language-server directory.
...
!!! note
    ...
    In this mode, the source maps for the client point to the source of the client, while the sourcemaps for the server point to the JavaScript files of the distronode-language-server under node_modules.
