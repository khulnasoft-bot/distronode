...
const entry: EntryType = {
  ...
  server: "./packages/distronode-language-server/src/server.ts",
        ...
        use: [
          {
            ...
            options: {
              compilerOptions: {
                configFile: "./packages/distronode-language-server/tsconfig.json",
                sourceMap: true,
              },
            },
          },
...
const createDistronodeCollectionWebviewConfig = {
  ...config,
  target: ["web", "es2020"],
  entry: "./src/webview/apps/contentCreator/createDistronodeCollectionPageApp.ts",
  experiments: { outputModule: true },
  output: {
    path: path.resolve(__dirname, "out"),
    filename:
      "./client/webview/apps/contentCreator/createDistronodeCollectionPageApp.js",
    libraryTarget: "module",
    chunkFormat: "module",
  },
};

const createDistronodeProjectWebviewConfig = {
  ...config,
  target: ["web", "es2020"],
  entry: "./src/webview/apps/contentCreator/createDistronodeProjectPageApp.ts",
  experiments: { outputModule: true },
  output: {
    path: path.resolve(__dirname, "out"),
    filename:
      "./client/webview/apps/contentCreator/createDistronodeProjectPageApp.js",
    libraryTarget: "module",
    chunkFormat: "module",
  },
};
