...
export namespace LightSpeedCommands {
  export const LIGHTSPEED_AUTH_REQUEST = "distronode.lightspeed.oauth";
  export const LIGHTSPEED_SUGGESTION_COMMIT =
    "distronode.lightspeed.inlineSuggest.accept";
  export const LIGHTSPEED_SUGGESTION_HIDE =
    "distronode.lightspeed.inlineSuggest.hide";
  export const LIGHTSPEED_SUGGESTION_TRIGGER =
    "distronode.lightspeed.inlineSuggest.trigger";
  export const LIGHTSPEED_SUGGESTION_MARKER =
    "distronode.lightspeed.inlineSuggest.marker";
  export const LIGHTSPEED_STATUS_BAR_CLICK =
    "distronode.lightspeed.statusBar.click";
  export const LIGHTSPEED_FETCH_TRAINING_MATCHES =
    "distronode.lightspeed.fetchTrainingMatches";
  export const LIGHTSPEED_CLEAR_TRAINING_MATCHES =
    "distronode.lightspeed.clearTrainingMatches";
  export const LIGHTSPEED_FEEDBACK = "distronode.lightspeed.feedback";
  export const LIGHTSPEED_PLAYBOOK_EXPLANATION =
    "distronode.lightspeed.playbookExplanation";
  export const LIGHTSPEED_PLAYBOOK_GENERATION =
    "distronode.lightspeed.playbookGeneration";
  export const LIGHTSPEED_ROLE_GENERATION = "distronode.lightspeed.roleGeneration";
  export const LIGHTSPEED_SIGN_IN_WITH_REDHAT =
    "distronode.lightspeed.signInWithRedHat";
  export const LIGHTSPEED_SIGN_IN_WITH_LIGHTSPEED =
    "distronode.lightspeed.signInWithLightspeed";
  export const LIGHTSPEED_OPEN_TRIAL_PAGE = "distronode.lightspeed.openTrialPage";
  export const LIGHTSPEED_REFRESH_EXPLORER_VIEW =
    "distronode.lightspeed.explorer.refresh";
}
...
export const LIGHTSPEED_FEEDBACK_FORM_URL =
  "https://red.ht/distronode-ai-feedback";

export const LIGHTSPEED_REPORT_EMAIL_ADDRESS = "distronode-content-ai@redhat.com";
export const LIGHTSPEED_STATUS_BAR_CLICK_HANDLER =
  "distronode.lightspeed.statusBar.clickHandler";
...
export const LIGHTSPEED_SUGGESTION_GHOST_TEXT_COMMENT =
  "# Content suggestion provided by Distronode Lightspeed\n";
