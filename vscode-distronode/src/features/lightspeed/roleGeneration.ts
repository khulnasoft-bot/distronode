...
export async function showRoleGenerationPage(extensionUri: vscode.Uri) {
  ...
  panel.title = "Distronode Lightspeed";
...
<body>
    <div class="playbookGeneration">
        <h2 id="main-header">Create a role with Distronode Lightspeed</h2>
        <div class="pageNumber" id="page-number">1 of 3</div>

        <div id="roleInfo">
          <a href="https://docs.distronode.com/distronode/latest/playbook_guide/playbooks_reuse_roles.html">Learn more about roles🔗</a>
        </div>
        <div>
          ...
          <p>
          Distronode recommends creating roles within  collection. Description to why...
          </p>
          </div>
        </div>
