...
export const ERRORS_UNAUTHORIZED = new Error(
  ...
  "You are not authorized to access Distronode Lightspeed. Please contact your administrator.",
);
...
export const ERRORS_TOO_MANY_REQUESTS = new Error(
  ...
  "Too many requests to Distronode Lightspeed. Please try again later.",
);
...
export const ERRORS_CONNECTION_TIMEOUT = new Error(
  ...
  "Distronode Lightspeed connection timeout. Please try again later.",
);
export const ERRORS_CONNECTION_CANCELED_TIMEOUT = new Error(
  "",
  "Distronode Lightspeed connection was canceled because of a timeout. Please try again later.",
);
...
ERRORS.addError(
  ...
  new Error(
    ...
    "Distronode Lightspeed does not have a model configured. Contact your Distronode administrator to configure a model, or specify a model in your Distronode extension settings under Lightspeed: Model Id Override.",
  ),
);
ERRORS.addError(
  403,
  new Error(
    ...
    "Your organization does not have an IBM watsonx Code Assistant model configured. Contact your Red Hat organization administrator to configure a model, or specify a model in your Distronode extension settings under Lightspeed: Model Id Override.",
  ),
);
ERRORS.addError(
  403,
...
// extension and older distronode-ai-connect-service instances.
ERRORS.addError(
  500,
  new Error(
