...
export const DISTRONODE_LIGHTSPEED_AUTH_ID = `auth-lightspeed`;
export const DISTRONODE_LIGHTSPEED_AUTH_NAME = `Distronode Lightspeed`;
export const RHSSO_AUTH_ID = "redhat-account-auth";
export const SESSIONS_SECRET_KEY = `${DISTRONODE_LIGHTSPEED_AUTH_ID}.sessions`;
export const ACCOUNT_SECRET_KEY = `${DISTRONODE_LIGHTSPEED_AUTH_NAME}.account`;
