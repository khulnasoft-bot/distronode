...
export function getWebviewContentWithLoginForm(
  ...
  <html lang="en">
    <head>
      ...
      <title>Distronode Lightspeed Explorer!</title>
    </head>
    <body>
    <div id="lightspeedExplorerView">
      Experience smarter automation using Distronode Lightspeed with watsonx Code Assistant solutions for your playbook. <a href="https://www.redhat.com/en/engage/project-wisdom">Learn more</a><br />
...
export function getWebviewContentWithActiveSession(
  ...
  <form id="playbook-explanation-form">
    <vscode-button id="lightspeed-explorer-playbook-explanation-submit" class="lightspeedExplorerButton" ${
      has_playbook_opened
        ? ""
        : "disabled title='The file in the active editor view is not an Distronode playbook' "
...
export function setWebviewMessageListener(
  ...
  webview.onDidReceiveMessage(
    ...
    (message: any) => {
      ...
      switch (command) {
        case "connect":
          commands.executeCommand("distronode.lightspeed.oauth");
          return;
        case "generate":
          commands.executeCommand("distronode.lightspeed.playbookGeneration");
          return;
        case "explain":
          commands.executeCommand("distronode.lightspeed.playbookExplanation");
          return;
      }
    },
    undefined,
