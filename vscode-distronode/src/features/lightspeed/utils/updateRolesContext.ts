...
export function updateRolesContext(
  distronodeRolesCache: IWorkSpaceRolesContext,
  ...
  for (const roleName of roleNames) {
    ...
    updateRoleContext(distronodeRolesCache, rolePath, workSpaceRoot);
  }
}
export function updateRoleContext(
  ...
  if (!distronodeRolesCache[workSpaceRoot]) {
    distronodeRolesCache[workSpaceRoot] = {};
  }
  const rolesContext = distronodeRolesCache[workSpaceRoot];
