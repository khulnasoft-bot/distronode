                ...
                <div class="image-div">
                  <div class="dropdown-container">
                    ...
                    <vscode-dropdown id="image-dropdown">
                      <vscode-option>Upstream (ghcr.io/distronode/community-distronode-dev-tools:latest)</vscode-option>
                      <vscode-option>Downstream (registry.redhat.io/distronode-automation-platform-25/distronode-dev-tools-rhel8:latest)</vscode-option>
                    </vscode-dropdown>
                  </div>
                </div>
