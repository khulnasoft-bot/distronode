...
export class AddPlugin {
  ...
  public async getCreatorCommand(
    ...
    command = `distronode-creator add plugin ${pluginType} ${pluginName} ${url} --no-ansi`;
    return command;
  }
  ...
  public async runAddCommand(
    ...
    let distronodeCreatorAddCommand = await this.getCreatorCommand(
      pluginName,
      pluginType,
      destinationPathUrl,
    );
    ...
    if (isOverwritten) {
      distronodeCreatorAddCommand += " --overwrite";
    } else {
      distronodeCreatorAddCommand += " --no-overwrite";
    }

    switch (verbosity) {
      case "Off":
        distronodeCreatorAddCommand += "";
        break;
      case "Low":
        distronodeCreatorAddCommand += " -v";
        break;
      case "Medium":
        distronodeCreatorAddCommand += " -vv";
        break;
      case "High":
        distronodeCreatorAddCommand += " -vvv";
        break;
    }

    console.debug("[distronode-creator] command: ", distronodeCreatorAddCommand);
  ...
  public async openFolderInWorkspace(
    ...
    console.log(`[distronode-creator] Plugin file url: ${pluginFileUrl}`);
