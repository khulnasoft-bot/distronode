        ...
        <body>
            ...
            <form id="devfile-form">
              <section class="component-container">
                ...
                <vscode-text-field id="devfile-name" form="devfile-form" placeholder="${projectName}" size="512">Distronode project name *</vscode-text-field>
                </div>
                ...
                <div class="image-div">
                  <div class="dropdown-container">
                    ...
                    <vscode-dropdown id="image-dropdown">
                      <vscode-option>Upstream (ghcr.io/distronode/distronode-workspace-env-reference:latest)</vscode-option>
                    </vscode-dropdown>
                  </div>
                </div>
