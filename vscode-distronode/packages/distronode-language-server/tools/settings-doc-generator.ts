...
const defaultSettings = {
  distronode: settingsManager.defaultSettingsWithDescription,
};
...
// ## [`distronode.distronode.path`](#xxx) {: #xxx }
const TEMPLATE = `
# Language Server Settings

The following are the default values of the settings provided by the Distronode Language Server:
