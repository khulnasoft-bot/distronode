...
import { DistronodeLanguageService } from "./distronodeLanguageService";
...
if (errorMessage) {
  connection.sendNotification("distronode/errorMessage", errorMessage);
}
...
const context = new DistronodeLanguageService(connectionProxy, documents);
context.initialize();
