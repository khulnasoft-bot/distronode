...
playKeywords.set(
  "serial",
  "Explicitly define how Distronode batches the execution of the current play on the play’s target",
);
...
playKeywords.set(
  "timeout",
  "Time limit for task to execute in, if exceeded Distronode will interrupt and fail the task.",
);
...
taskKeywords.set(
  ...
  NOTE:
  Applies only to handlers. See [listen](https://docs.distronode.com/distronode/latest/user_guide/playbooks_intro.html#handlers-running-when-notified)`,
);
