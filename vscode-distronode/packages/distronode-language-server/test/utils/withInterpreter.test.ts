  ...
  const tests: testType[] = [
    {
      ...
      expectedCommand:
        "bash -c 'source /path/to/venv/bin/activate && distronode-lint playbook.yml'",
      expectedEnv: {},
    },
    {
      ...
      interpreterPath: "",
      activationScript: "",
      expectedCommand: "distronode-lint playbook.yml",
      expectedEnv: {},
    },
    {
      scenario: "when absolute path of executable is provided",
      executable: "/absolute/path/to/distronode-lint",
      args: "playbook.yml",
      interpreterPath: "",
      activationScript: "",
      expectedCommand: "/absolute/path/to/distronode-lint playbook.yml",
      expectedEnv: {},
    },
    {
