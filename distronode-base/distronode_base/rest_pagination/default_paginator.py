...
logger = logging.getLogger('distronode_base.rest_pagination.default_paginator')
...
class DefaultPaginator(PageNumberPagination):
    ...
    def paginate_queryset(self, queryset, request, view=None):
        ...
        # https://github.com/distronode/awx/commit/c0d9600b66a8b271e4da9b74d0706c6d40ee62bf#diff-d87f638f22a7a23098410cc35ff29b4d811332b31122a04e8cb4f4d00143aa62R57
