...
from distronode_base.lib.utils.models import is_system_user
from distronode_base.lib.utils.settings import get_setting

oauth2_provider_installed = "distronode_base.oauth2_provider" in get_setting("INSTALLED_APPS", [])
...
def try_add_oauth2_scope_permission(permission_classes: list):
    ...
    :return: A list of permission_classes, including OAuth2ScopePermission
        if distronode_base.oauth2_provider is installed; otherwise the same
