...
logger = logging.getLogger('distronode_base.lib.sessions.stores.cached_dynamic_timeout')


class SessionStore(CachedDBSessionStore):
    cache_key_prefix = 'distronode_base.lib.sessions.stores.cached_dynamic_timeout'
