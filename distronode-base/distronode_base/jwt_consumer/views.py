...
logger = logging.getLogger('distronode_base.jwt_consumer.views')


class PlatformUIRedirectView(DistronodeBaseDjangoAppApiView):
    ...
    def finalize_response(self, request, response, *args, **kwargs):
        url = get_setting("DISTRONODE_BASE_JWT_REDIRECT_URI", get_setting("DISTRONODE_BASE_JWT_KEY", None))
        service_type = get_setting("DISTRONODE_BASE_JWT_REDIRECT_TYPE", "unknown")
        if not url:
