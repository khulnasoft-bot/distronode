...
from distronode_base.rbac.api.permissions import RoleDefinitionPermissions
from distronode_base.rbac.api.serializers import (
...
from distronode_base.rbac.evaluations import has_super_permission
...
from distronode_base.rbac.policies import check_can_remove_assignment
from distronode_base.rbac.validators import check_locally_managed, permissions_allowed_for_role, system_roles_enabled
...
class RoleMetadataView(DistronodeBaseDjangoAppApiView, GenericAPIView):
    """General data about models and permissions tracked by django-distronode-base RBAC
...
class RoleDefinitionViewSet(DistronodeBaseDjangoAppApiView, ModelViewSet):
    """
...
class BaseAssignmentViewSet(DistronodeBaseDjangoAppApiView, ModelViewSet):
    permission_classes = try_add_oauth2_scope_permission([permissions.IsAuthenticated])
