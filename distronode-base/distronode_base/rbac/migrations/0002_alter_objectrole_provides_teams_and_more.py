...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        migrations.swappable_dependency(settings.DISTRONODE_BASE_TEAM_MODEL),
    ...
    operations = [
        migrations.AlterField(
            ...
            name='provides_teams',
            field=models.ManyToManyField(editable=False, help_text='Users who have this role obtain member access to these teams, and inherit all their permissions.', related_name='member_roles', to=settings.DISTRONODE_BASE_TEAM_MODEL),
        ),
        migrations.AlterField(
            model_name='objectrole',
        ...
        migrations.AlterField(
            model_name='objectrole',
            name='teams',
            field=models.ManyToManyField(help_text='Teams or groups who have access to the permissions defined by this object role.', related_name='has_roles', through='dab_rbac.RoleTeamAssignment', to=settings.DISTRONODE_BASE_TEAM_MODEL),
        ),
        migrations.AlterField(
            model_name='objectrole',
            name='users',
