...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='roleteamassignment',
            name='team',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.DISTRONODE_BASE_TEAM_MODEL, related_name='role_assignments'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('provides_teams', models.ManyToManyField(
                    ...
                    related_name='member_roles', to=settings.DISTRONODE_BASE_TEAM_MODEL)),
                ('role_definition', models.ForeignKey(
