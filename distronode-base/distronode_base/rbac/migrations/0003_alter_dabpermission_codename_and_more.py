...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='roleteamassignment',
            name='team',
            field=models.ForeignKey(help_text='The team that receives permissions.', on_delete=django.db.models.deletion.CASCADE, related_name='role_assignments', to=settings.DISTRONODE_BASE_TEAM_MODEL),
        ),
        migrations.AlterField(
