...
logger = logging.getLogger('distronode_base.activitystream.signals')
...
def _store_activitystream_entry(old, new, operation):
    ...
    from distronode_base.lib.utils.models import diff
...
def _store_activitystream_m2m(given_instance, model, operation, pk_set, reverse, field_name):
    ...
    from distronode_base.activitystream.models import Entry
    from distronode_base.lib.utils.models import current_user_or_system_user
