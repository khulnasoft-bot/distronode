...
from distronode_base.activitystream.filtering import ActivityStreamFilterBackend
from distronode_base.activitystream.models import Entry
from distronode_base.activitystream.serializers import EntrySerializer
...
def calculate_filter_backends():
    ...
    """
    default_filter_backends = DistronodeBaseDjangoAppApiView.filter_backends
    filter_backends = []
...
class EntryReadOnlyViewSet(ReadOnlyModelViewSet, DistronodeBaseDjangoAppApiView):
    """
    ...
    def get_permissions(self):
        ...
        if 'distronode_base.rbac' in settings.INSTALLED_APPS:
            # TODO: permission_classes = [DistronodeBaseObjectPermissions] is not applicable now,
