...
from distronode_base.lib.utils.settings import get_setting, is_aoc_instance
from distronode_base.lib.utils.validation import validate_image_data, validate_url
from distronode_base.lib.utils.views.django_app_api import DistronodeBaseDjangoAppApiView

logger = logging.getLogger('distronode_base.authentication.views.ui_auth')


class UIAuth(DistronodeBaseDjangoAppApiView):
