...
from distronode_base.authentication.authenticator_plugins.utils import generate_authenticator_slug, get_authenticator_class, get_authenticator_plugins
from distronode_base.authentication.models import Authenticator, AuthenticatorUser
from distronode_base.lib.utils.response import get_fully_qualified_url

logger = logging.getLogger('distronode_base.authentication.social_auth')
...
class AuthenticatorStrategy(DjangoStrategy):
    def __init__(self, storage, request=None, tpl=None):
        ...
        self.settings = {}
        fq_function_name = getattr(settings, 'DISTRONODE_BASE_SOCIAL_AUTH_STRATEGY_SETTINGS_FUNCTION', None)
        if fq_function_name:
