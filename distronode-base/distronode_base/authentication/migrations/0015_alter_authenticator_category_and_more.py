...
import distronode_base.authentication.models.authenticator
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='authenticator',
            name='order',
            field=models.IntegerField(default=distronode_base.authentication.models.authenticator.get_next_authenticator_order, help_text='The order in which an authenticator will be tried. This only pertains to username/password authenticators.'),
        ),
        migrations.AlterField(
            model_name='authenticator',
            name='remove_users',
