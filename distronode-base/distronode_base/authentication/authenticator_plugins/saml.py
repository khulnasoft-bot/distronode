...
from distronode_base.authentication.authenticator_plugins.base import AbstractAuthenticatorPlugin, BaseAuthenticatorConfiguration
...
from distronode_base.lib.serializers.fields import CharField, JSONField, ListField, PrivateKey, PublicCert, URLField
...
from distronode_base.lib.utils.settings import get_setting
from distronode_base.lib.utils.validation import validate_cert_with_key

logger = logging.getLogger('distronode_base.authentication.authenticator_plugins.saml')
...
class AuthenticatorPlugin(SocialAuthMixin, SocialAuthValidateCallbackMixin, SAMLAuth, AbstractAuthenticatorPlugin):
    ...
    def extra_data(self, user, backend, response, *args, **kwargs):
        ...
        for perm in ["is_superuser", get_setting('DISTRONODE_BASE_SOCIAL_AUDITOR_FLAG')]:
            if perm in attrs:
