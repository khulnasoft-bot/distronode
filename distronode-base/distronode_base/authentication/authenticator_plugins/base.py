...
from distronode_base.lib.serializers.fields import JSONField
from distronode_base.lib.utils.response import get_relative_url

logger = logging.getLogger('distronode_base.authentication.authenticator_plugins.base')
...
class AbstractAuthenticatorPlugin:
    ...
    def set_logger(self, logger) -> None:
        if not logger:
            self.logger = logging.getLogger('distronode_base.authentication.models.abstract_authenticator')
        else:
            self.logger = logger
