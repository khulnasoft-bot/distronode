...
from distronode_base.authentication.utils.authentication import get_or_create_authenticator_user
from distronode_base.authentication.utils.claims import update_user_claims
from distronode_base.lib.serializers.fields import BooleanField, CharField, ChoiceField, IntegerField
from distronode_base.lib.utils.requests import get_remote_host

logger = logging.getLogger('distronode_base.authentication.authenticator_plugins.tacacs')
...
class TacacsConfiguration(BaseAuthenticatorConfiguration):
    documentation_url = "https://github.com/distronode/tacacs_plus"
    HOST = CharField(
        label="TACACS+ Server",
        required=True,
