...
from distronode_base.resource_registry.models import Resource, init_resource_from_object
...
def sync_to_resource_server_pre_delete(sender, instance, **kwargs):
    ...
    sync_to_resource_server(instance, "delete", distronode_id=instance.resource.distronode_id)
