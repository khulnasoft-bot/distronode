...
logger = logging.getLogger('distronode_base.serializers')
...
class ResourceListSerializer(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        instance.update_resource(
            ...
            distronode_id=validated_data.get("distronode_id"),
    ...
    # allow setting distronode ID at create time
    def create(self, validated_data):
        try:
            ...
            return Resource.create_resource(
                resource_type, validated_data["resource_data"], distronode_id=validated_data.get("distronode_id"), service_id=validated_data.get("service_id")
            )
