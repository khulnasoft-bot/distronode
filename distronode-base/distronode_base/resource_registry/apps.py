...
from distronode_base.lib.utils.db import ensure_transaction, migrations_are_complete
from distronode_base.resource_registry.utils.settings import resource_server_defined

logger = logging.getLogger('distronode_base.resource_registry.apps')
...
def initialize_resources(sender, **kwargs):
    ...
    from distronode_base.resource_registry.models import init_resource_from_object
...
class ResourceRegistryConfig(AppConfig):
    ...
    name = 'distronode_base.resource_registry'
