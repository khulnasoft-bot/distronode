...
def get_registry() -> ResourceRegistry:
    ...
    if hasattr(settings, "DISTRONODE_BASE_RESOURCE_CONFIG_MODULE"):
        from django.utils.module_loading import import_string

        resource_list = import_string(settings.DISTRONODE_BASE_RESOURCE_CONFIG_MODULE + ".RESOURCE_LIST")
        api_config = import_string(settings.DISTRONODE_BASE_RESOURCE_CONFIG_MODULE + ".APIConfig")
