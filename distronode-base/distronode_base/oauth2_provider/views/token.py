...
from distronode_base.oauth2_provider.models import OAuth2AccessToken, OAuth2RefreshToken
from distronode_base.oauth2_provider.permissions import OAuth2ScopePermission
from distronode_base.oauth2_provider.serializers import OAuth2TokenSerializer
from distronode_base.oauth2_provider.views.permissions import OAuth2TokenPermission
...
class OAuth2TokenViewSet(ModelViewSet, DistronodeBaseDjangoAppApiView):
