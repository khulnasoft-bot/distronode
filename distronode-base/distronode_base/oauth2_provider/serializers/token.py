...
from distronode_base.lib.serializers.common import CommonModelSerializer
...
from distronode_base.oauth2_provider.models.access_token import SCOPES

logger = logging.getLogger("distronode_base.oauth2_provider.serializers.token")
