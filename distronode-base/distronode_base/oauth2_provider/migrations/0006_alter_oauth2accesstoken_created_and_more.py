...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='oauth2accesstoken',
            name='scope',
            field=models.CharField(default='write', help_text="Allowed scopes, further restricts user permissions. Must be a simple space-separated string with allowed scopes ['read', 'write'].", max_length=32, validators=[distronode_base.oauth2_provider.models.access_token.validate_scope]),
        ),
        migrations.AlterField(
            model_name='oauth2accesstoken',
            name='user',
