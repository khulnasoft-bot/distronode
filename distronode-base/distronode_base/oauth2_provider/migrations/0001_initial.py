...
import distronode_base.oauth2_provider.models.application
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization', models.ForeignKey(help_text='Organization containing this application.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='applications', to=settings.DISTRONODE_BASE_ORGANIZATION_MODEL)),
