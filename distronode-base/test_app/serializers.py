...
from distronode_base.lib.serializers.common import CommonModelSerializer, CommonUserSerializer, ImmutableCommonModelSerializer, NamedCommonModelSerializer
...
class PublicDataSerializer(NamedCommonModelSerializer):
    class Meta:
