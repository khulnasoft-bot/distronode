...
from distronode_base.lib.utils.response import get_fully_qualified_url
...
from distronode_base.oauth2_provider.views import DABOAuth2UserViewsetMixin
from distronode_base.rbac import permission_registry
from distronode_base.rbac.api.permissions import DistronodeBaseUserPermissions
from distronode_base.rbac.policies import visible_users
from test_app import models, serializers

logger = logging.getLogger(__name__)


class TestAppViewSet(ModelViewSet, DistronodeBaseView):
    prefetch_related = ()
    select_related = ()
...
class UserViewSet(DABOAuth2UserViewsetMixin, TestAppViewSet):
    ...
    permission_classes = [OAuth2ScopePermission, DistronodeBaseUserPermissions]
...
def api_root(request, format=None):
    from distronode_base.activitystream.urls import router as activitystream_router
    from distronode_base.authentication.urls import router as auth_router
    from distronode_base.oauth2_provider.urls import router as oauth2_provider_router
    from distronode_base.rbac.api.router import router as rbac_router
    from distronode_base.resource_registry.urls import service_router
    ...
    from distronode_base.api_documentation.urls import api_version_urls as docs_urls
    from distronode_base.authentication.urls import api_version_urls as authentication_urls
