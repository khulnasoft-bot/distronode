...
from distronode_base.lib.utils.requests import get_remote_host, get_remote_hosts, is_proxied_request
...
def test_get_remote_host(return_value, expected_value):
    ...
    with mock.patch('distronode_base.lib.utils.requests.get_remote_hosts', return_value=return_value):
...
@mock.patch("distronode_base.lib.utils.requests.validate_x_trusted_proxy_header", side_effect=Exception)
