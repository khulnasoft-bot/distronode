...
def test_authentication_user_in_urls(view_set, expect_url):
    from distronode_base.authentication import urls

    with mock.patch('distronode_base.authentication.views.authenticator_users.get_authenticator_user_view', return_value=view_set):
