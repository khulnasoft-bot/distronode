...
from distronode_base.authentication.authenticator_plugins.local import AuthenticatorPlugin
...
def test_local_auth_create_configuration_must_be_empty(admin_api_client, configuration, expected_status_code, shut_up_logging):
    ...
    data = {
        ...
        "create_objects": True,
        "remove_users": True,
        "type": "distronode_base.authentication.authenticator_plugins.local",
    }
...
def test_local_auth_configuration_validate():
    ...
    from distronode_base.authentication.authenticator_plugins.local import LocalConfiguration
...
def test_local_auth_instance_not_enabled(local_authenticator, expected_log):
    ...
    with expected_log('distronode_base.authentication.authenticator_plugins.local.logger', "info", "is disabled, skipping"):
