...
from distronode_base.authentication.authenticator_plugins.saml import AuthenticatorPlugin
...
from distronode_base.lib.utils.response import get_fully_qualified_url, get_relative_url

authenticated_test_page = "authenticator-list"


@mock.patch("rest_framework.views.APIView.authentication_classes", [SessionAuthentication])
@mock.patch("distronode_base.authentication.authenticator_plugins.saml.AuthenticatorPlugin.authenticate")
...
def test_extra_data(mockedsuper):
    ...
    rDict = {}
    rDict["attributes"] = {}
    rDict["attributes"][settings.DISTRONODE_BASE_SOCIAL_AUDITOR_FLAG] = "True"
    rDict["attributes"]["Group"] = ["mygroup"]
    social = SocialUser()
    ap.extra_data(None, None, response=rDict, social=social)
    assert mockedsuper.called
    assert settings.DISTRONODE_BASE_SOCIAL_AUDITOR_FLAG in social.extra_data
...
def test_extra_data_default_attrs(idp_fields, expected_results):
    from distronode_base.authentication.authenticator_plugins.saml import idp_string
...
def test_saml_callback_url_is_acs_url(rsa_keypair_with_cert):
    ...
    """
    from distronode_base.authentication.authenticator_plugins.utils import get_authenticator_plugin
