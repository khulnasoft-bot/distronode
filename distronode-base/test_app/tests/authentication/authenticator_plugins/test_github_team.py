...
@mock.patch("distronode_base.authentication.authenticator_plugins.github_team.AuthenticatorPlugin.authenticate")
...
@mock.patch("rest_framework.views.APIView.authentication_classes", [SessionAuthentication])
@mock.patch("distronode_base.authentication.authenticator_plugins.github_team.AuthenticatorPlugin.authenticate", return_value=None)
