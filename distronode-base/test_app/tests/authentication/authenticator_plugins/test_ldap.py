...
from distronode_base.authentication.authenticator_plugins.ldap import AuthenticatorPlugin, LDAPSettings, validate_ldap_filter
from distronode_base.authentication.models import Authenticator
from distronode_base.authentication.session import SessionAuthentication
from distronode_base.lib.utils.encryption import ENCRYPTED_STRING
...
@mock.patch("distronode_base.authentication.authenticator_plugins.ldap.AuthenticatorPlugin.authenticate")
...
@mock.patch("rest_framework.views.APIView.authentication_classes", [SessionAuthentication])
@mock.patch("distronode_base.authentication.authenticator_plugins.ldap.AuthenticatorPlugin.authenticate", return_value=None)
...
@mock.patch("rest_framework.views.APIView.authentication_classes", [SessionAuthentication])
@mock.patch("distronode_base.authentication.authenticator_plugins.ldap.AuthenticatorPlugin.authenticate", return_value=None)
@mock.patch("distronode_base.authentication.authenticator_plugins.ldap.config.LDAPSearch", side_effect=Exception("Something went wrong"))
def test_ldap_search_exception(
    ...
    data = {
        ...
        "type": "distronode_base.authentication.authenticator_plugins.ldap",
    }
...
@mock.patch("rest_framework.views.APIView.authentication_classes", [SessionAuthentication])
@mock.patch("distronode_base.authentication.authenticator_plugins.ldap.LDAPBackend.authenticate", return_value=None)
@mock.patch("distronode_base.authentication.authenticator_plugins.ldap.logger")
@pytest.mark.parametrize(
...
@pytest.mark.django_db
@mock.patch("rest_framework.views.APIView.authentication_classes", [SessionAuthentication])
@mock.patch("distronode_base.authentication.authenticator_plugins.ldap.LDAPBackend.authenticate")
@mock.patch("distronode_base.authentication.authenticator_plugins.ldap.logger")
