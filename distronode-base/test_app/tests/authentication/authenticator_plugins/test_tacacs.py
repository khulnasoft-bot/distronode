...
from distronode_base.authentication.authenticator_plugins.tacacs import AuthenticatorPlugin, validate_tacacsplus_disallow_nonascii
...
@mock.patch("distronode_base.authentication.authenticator_plugins.tacacs.AuthenticatorPlugin.authenticate")
...
@mock.patch("distronode_base.authentication.authenticator_plugins.tacacs.logger")
...
def test_tacacs_authenticate_no_database_instance(expected_log):
    expected_log = partial(expected_log, "distronode_base.authentication.authenticator_plugins.tacacs.logger")
    tacacs_authenticator_plugin = AuthenticatorPlugin()
...
def test_tacacs_authenticate_with_authentication(expected_log, tacacs_authenticator, randname, password, user_is_valid, pre_create_user, response):
    ...
    expected_log = partial(expected_log, "distronode_base.authentication.utils.authentication.logger")
