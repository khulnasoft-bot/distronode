...
from distronode_base.authentication.authenticator_plugins.oidc import AuthenticatorPlugin
...
@mock.patch("distronode_base.authentication.authenticator_plugins.oidc.AuthenticatorPlugin.authenticate")
...
@mock.patch("rest_framework.views.APIView.authentication_classes", [SessionAuthentication])
@mock.patch("distronode_base.authentication.authenticator_plugins.oidc.AuthenticatorPlugin.authenticate", return_value=None)
