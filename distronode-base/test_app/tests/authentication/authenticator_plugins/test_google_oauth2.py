...
@mock.patch("distronode_base.authentication.authenticator_plugins.google_oauth2.AuthenticatorPlugin.authenticate")
...
@mock.patch("rest_framework.views.APIView.authentication_classes", [SessionAuthentication])
@mock.patch("distronode_base.authentication.authenticator_plugins.google_oauth2.AuthenticatorPlugin.authenticate", return_value=None)
