...
from distronode_base.authentication.authenticator_plugins.keycloak import AuthenticatorPlugin
...
@mock.patch("distronode_base.authentication.authenticator_plugins.keycloak.AuthenticatorPlugin.authenticate")
