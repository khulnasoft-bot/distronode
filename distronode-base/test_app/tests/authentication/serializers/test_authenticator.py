...
from distronode_base.authentication.serializers import AuthenticatorSerializer
...
def test_authenticator_validate_import_error(shut_up_logging):
    ...
    with (
        mock.patch(
            "distronode_base.authentication.serializers.authenticator.AuthenticatorSerializer.context",
            return_value={'request': {'method': 'PUT'}},
        ),
        mock.patch(
            "distronode_base.authentication.serializers.authenticator.get_authenticator_plugin",
