...
from distronode_base.authentication.views.ui_auth import generate_ui_auth_data
...
@mock.patch("distronode_base.authentication.views.ui_auth.logger")
...
def test_generate_ui_auth_data_managed_cloud(is_cloud):
    with override_settings(DISTRONODE_BASE_MANAGED_CLOUD_INSTALL=is_cloud):
