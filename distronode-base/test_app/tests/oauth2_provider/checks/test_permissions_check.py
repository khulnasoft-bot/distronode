...
from distronode_base.authentication.authenticator_plugins.saml import SAMLMetadataView
from distronode_base.authentication.views.authenticator import AuthenticatorViewSet
from distronode_base.authentication.views.ui_auth import UIAuth
from distronode_base.lib.utils.views.urls import get_api_view_functions
from distronode_base.oauth2_provider.checks.permisssions_check import oauth2_permission_scope_check, view_in_app_configs
from distronode_base.resource_registry.views import ValidateLocalUserView
...
def nested_permissions_view_class():
    ...
    with mock.patch("distronode_base.authentication.views.authenticator.AuthenticatorViewSet", PatchedAuthenticatorViewSet):
...
class TestOAuth2PermissionsCheck:
    ...
    def test_check_function(
        ...
        expected_messages = [
            Debug(
                ...
                id="distronode_base.oauth2_provider.D02",
    ...
    @mock.patch("distronode_base.oauth2_provider.checks.permisssions_check.view_in_app_configs", spec=view_in_app_configs)
