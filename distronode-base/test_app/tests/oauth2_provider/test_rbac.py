...
from distronode_base.oauth2_provider.models import OAuth2AccessToken
...
@pytest.mark.parametrize(
    ...
    [
        ('superuser', True),
        pytest.param('admin_of_app_user_org', True, marks=pytest.mark.xfail(reason="https://github.com/distronode/distronode/tree/devel/distronode-base/issues/424")),
        pytest.param('user_in_org', True, marks=pytest.mark.xfail(reason="https://github.com/distronode/distronode/tree/devel/distronode-base/issues/424")),
        ('user', False),
        ('anon', False),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ('superuser', True),
        pytest.param('admin_of_app_org', True, marks=pytest.mark.xfail(reason="https://github.com/distronode/distronode/tree/devel/distronode-base/issues/424")),
        ('user_in_org', False),
        ('user', False),
        ('anon', False),
    ],
...
@pytest.mark.parametrize(
    ...
    [
        ('superuser', True),
        pytest.param('admin_of_app_user_org', True, marks=pytest.mark.xfail(reason="https://github.com/distronode/distronode/tree/devel/distronode-base/issues/424")),
        pytest.param('user_in_app_org', True, marks=pytest.mark.xfail(reason="https://github.com/distronode/distronode/tree/devel/distronode-base/issues/424")),
        ('user', False),
        ('anon', False),
    ],
)
