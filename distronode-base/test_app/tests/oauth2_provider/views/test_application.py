...
from distronode_base.oauth2_provider.models import OAuth2AccessToken, OAuth2Application, OAuth2RefreshToken
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param("user_api_client", 200, marks=pytest.mark.xfail(reason="https://github.com/distronode/distronode/tree/devel/distronode-base/issues/424")),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param("user_api_client", 201, marks=pytest.mark.xfail(reason="https://github.com/distronode/distronode/tree/devel/distronode-base/issues/424")),
        ("unauthenticated_api_client", 401),
    ],
)
...
def test_oauth2_provider_application_client_secret_encrypted(admin_api_client, organization):
    ...
    # assert distronode_encryption.decrypt_string(encrypted) == response.data['client_secret'], response.data
