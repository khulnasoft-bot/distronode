...
from distronode_base.lib.testing.util import StaticResourceAPIClient
from distronode_base.lib.utils.response import get_relative_url
from distronode_base.resource_registry.tasks.sync import ResourceSyncHTTPError, SyncExecutor
...
def test_update_existing_resource(admin_api_client, static_api_client, stdout):
    ...
    resource = {
        "resource_type": "shared.user",
        "service_id": "57592fbc-7ecb-405f-9f5f-ebad20932d38",  # from fixtures/static/metadata
        "distronode_id": "97447387-8596-404f-b0d0-6429b04c8d22",  # from fixtures/status/resources/{id}
        "resource_data": {
            "username": "theceo",
