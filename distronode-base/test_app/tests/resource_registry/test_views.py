...
def test_resource_type_manifest_default(admin_api_client, admin_user, user):
    ...
    assert str(user.resource.distronode_id) in r_text
    assert str(admin_user.resource.distronode_id) in r_text
...
def test_resource_manifest_non_default_service_id(admin_api_client, admin_user, user):
    ...
    assert str(user.resource.distronode_id) not in r_text
    ...
    assert str(admin_user.resource.distronode_id) not in r_text
    assert str(user.resource.distronode_id) in r_text
