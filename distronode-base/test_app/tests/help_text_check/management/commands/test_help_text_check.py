...
def test_valid_exception_types(read_data, has_message):
    ...
    with mock.patch('distronode_base.help_text_check.management.commands.help_text_check.apps.get_models', return_value=[]):
...
def test_app_limit():
    from distronode_base.help_text_check.management.commands.help_text_check import Command

    command = Command()

    with mock.patch.dict('distronode_base.help_text_check.management.commands.help_text_check.apps.app_configs', {'App1': [], 'App2': [], 'App3': []}):
        with mock.patch('distronode_base.help_text_check.management.commands.help_text_check.apps.get_app_config') as get_app_config:
...
def test_models(test_type):
    ...
    with mock.patch.dict('distronode_base.help_text_check.management.commands.help_text_check.apps.app_configs', {test_type: []}):
        with mock.patch('distronode_base.help_text_check.management.commands.help_text_check.apps.get_app_config') as get_app_config:
