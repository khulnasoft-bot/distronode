...
from distronode_base.jwt_consumer.views import PlatformUIRedirectView
...
@override_settings(DISTRONODE_BASE_JWT_REDIRECT_URI='https://example.com')
@override_settings(DISTRONODE_BASE_JWT_KEY='https://example2.com')
...
@override_settings(DISTRONODE_BASE_JWT_KEY='https://example2.com/something/else')
@override_settings(DISTRONODE_BASE_JWT_REDIRECT_TYPE='gibberish')
...
@override_settings(DISTRONODE_BASE_JWT_KEY='https://example.com')
