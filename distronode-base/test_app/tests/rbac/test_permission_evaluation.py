...
from distronode_base.rbac.models import ObjectRole, RoleDefinition, RoleEvaluation, RoleUserAssignment
...
@pytest.mark.django_db
@override_settings(DISTRONODE_BASE_BYPASS_SUPERUSER_FLAGS=['is_superuser'])
...
@pytest.mark.django_db
@override_settings(DISTRONODE_BASE_BYPASS_SUPERUSER_FLAGS=[])
...
class TestMultipleMemberRoles:
    ...
    @override_settings(DISTRONODE_BASE_DELETE_REQUIRE_CHANGE=False)
