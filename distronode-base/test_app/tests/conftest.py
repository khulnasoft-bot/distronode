...
from distronode_base.lib.testing.fixtures import *  # noqa: F403, F401
from distronode_base.lib.testing.util import copy_fixture, delete_authenticator
from distronode_base.oauth2_provider.fixtures import *  # noqa: F403, F401
from distronode_base.rbac import permission_registry
from distronode_base.rbac.models import RoleDefinition
from distronode_base.resource_registry.models.service_identifier import service_id
...
def azuread_authenticator(azuread_configuration):
    ...
    authenticator = Authenticator.objects.create(
        ...
        create_objects=True,
        remove_users=True,
        type="distronode_base.authentication.authenticator_plugins.azuread",
...
def github_authenticator(github_configuration):
    ...
    authenticator = Authenticator.objects.create(
        ...
        create_objects=True,
        remove_users=True,
        type="distronode_base.authentication.authenticator_plugins.github",
...
def github_organization_authenticator(github_organization_configuration):
    ...
    authenticator = Authenticator.objects.create(
        ...
        create_objects=True,
        remove_users=True,
        type="distronode_base.authentication.authenticator_plugins.github_org",
...
def github_team_authenticator(github_team_configuration):
    ...
    authenticator = Authenticator.objects.create(
        ...
        create_objects=True,
        remove_users=True,
        type="distronode_base.authentication.authenticator_plugins.github_team",
...
def github_enterprise_authenticator(github_enterprise_configuration):
    ...
    authenticator = Authenticator.objects.create(
        ...
        create_objects=True,
        remove_users=True,
        type="distronode_base.authentication.authenticator_plugins.github_enterprise",
...
def github_enterprise_organization_authenticator(github_enterprise_organization_configuration):
    ...
    authenticator = Authenticator.objects.create(
        ...
        create_objects=True,
        remove_users=True,
        type="distronode_base.authentication.authenticator_plugins.github_enterprise_org",
...
def github_enterprise_team_authenticator(github_enterprise_team_configuration):
    ...
    authenticator = Authenticator.objects.create(
        ...
        create_objects=True,
        remove_users=True,
        type="distronode_base.authentication.authenticator_plugins.github_enterprise_team",
...
def google_oauth2_authenticator(google_oauth2_configuration):
    ...
    authenticator = Authenticator.objects.create(
        ...
        create_objects=True,
        remove_users=True,
        type="distronode_base.authentication.authenticator_plugins.google_oauth2",
...
def oidc_authenticator(oidc_configuration):
    ...
    authenticator = Authenticator.objects.create(
        ...
        create_objects=True,
        remove_users=True,
        type="distronode_base.authentication.authenticator_plugins.oidc",
...
def tacacs_authenticator(tacacs_configuration):
    ...
    authenticator = Authenticator.objects.create(
        ...
        create_objects=True,
        remove_users=True,
        type="distronode_base.authentication.authenticator_plugins.tacacs",
...
def radius_authenticator(db, radius_configuration):
    ...
    authenticator = Authenticator.objects.create(
        ...
        create_objects=True,
        remove_users=True,
        type="distronode_base.authentication.authenticator_plugins.radius",
...
def saml_configuration(rsa_keypair_with_cert, rsa_keypair_with_cert_1):
    return {
        "CALLBACK_URL": "https://localhost/api/social/complete/distronode_base-authenticator_plugins-saml__test-saml-authenticator/",
...
def saml_authenticator(saml_configuration):
    from distronode_base.authentication.authenticator_plugins.saml import SAMLConfiguration
    from distronode_base.authentication.models import Authenticator
    ...
    authenticator = Authenticator.objects.create(
        ...
        create_objects=True,
        remove_users=True,
        type="distronode_base.authentication.authenticator_plugins.saml",
...
def keycloak_authenticator(db):
    ...
    authenticator = Authenticator.objects.create(
        ...
        create_objects=True,
        remove_users=True,
        type="distronode_base.authentication.authenticator_plugins.keycloak",
        configuration={
    ...
    class Token:
        def __init__(self):
            ...
            self.unencrypted_token = {
                "version": "1",
                "iss": "distronode-issuer",
                "exp": int(expiration_date.timestamp()),
                "aud": "distronode-services",
...
def disable_activity_stream():
    ...
    """
    from distronode_base.activitystream import no_activity_stream
...
def external_auditor_constructor():
    data = settings.DISTRONODE_BASE_MANAGED_ROLE_REGISTRY.copy()
    data['ext_aud'] = {'shortname': 'sys_auditor', 'name': 'Ext Auditor'}
    jwt_roles = settings.DISTRONODE_BASE_JWT_MANAGED_ROLES.copy()
    jwt_roles.append('Ext Auditor')
    with override_settings(DISTRONODE_BASE_MANAGED_ROLE_REGISTRY=data, DISTRONODE_BASE_JWT_MANAGED_ROLES=jwt_roles):
...
def unmanaged_external_auditor_constructor():
    ...
    with override_settings(DISTRONODE_BASE_MANAGED_ROLE_REGISTRY=data):
        # Extra setup needed for external auditor
        permission_registry.register_managed_role_constructors()
