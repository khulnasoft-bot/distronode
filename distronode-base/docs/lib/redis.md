...
django-distronode-base offers a redis client which allows for single/clustered nodes as well as with or without TLS.
...
```
    CACHES = {
        "default": {
            ...
            "OPTIONS": {
                "CLIENT_CLASS": "distronode_base.lib.redis.RedisClient",
                "CLIENT_CLASS_KWARGS": {
