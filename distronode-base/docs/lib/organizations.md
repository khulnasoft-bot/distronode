...
The django-distronode-base project provides the 
`distronode_base.lib.abstract_models.organization.AbstractOrganization` base class. Projects that implement 
...
for the list of remaining fields see `distronode_base.lib.abstract_models.common.CommonModel`.
