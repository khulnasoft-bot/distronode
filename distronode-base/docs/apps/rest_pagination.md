...
django-distronode-base provides a method for paginating rest framework list views.

## Installation

Add `distronode_base.rest_pagination` to your installed apps:
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PAGINATION_CLASS': 'distronode_base.rest_pagination.DefaultPaginator'
    ...
}
```
