...
django-distronode-base uses django-spectacular to auto-generate both Open API and Swagger documentation of the API.

## Settings

Add `distronode_base.api_documentation` to your installed apps:
...
```
from distronode_base.api_documentation import urls
