...
export function formatPath(
  ...
  // insights router has basename="/", "/beta/" or "/preview/", with hub under a nested "distronode/automation-hub" route - our urls are relative to that
  let url = IS_INSIGHTS
...
export const Paths = {
  distronodeRemoteDetail: '/distronode/remotes/:name',
  distronodeRemoteEdit: '/distronode/remotes/:name/edit',
  distronodeRemotes: '/distronode/remotes',
  distronodeRepositories: '/distronode/repositories',
  distronodeRepositoryDetail: '/distronode/repositories/:name',
  distronodeRepositoryEdit: '/distronode/repositories/:name/edit',
