...
class DistronodeRoleNamespaceDetail extends Component<
  RouteProps,
  RoleNamespaceState
> {
  ...
  render() {
    ...
    const dropdownItems = [
      showLightspeed && (
        ...
        >{t`Distronode Lightspeed settings`}</DropdownItem>
      ),
      is_superuser && (
        <DropdownItem
...
export default withRouter(DistronodeRoleNamespaceDetail);
