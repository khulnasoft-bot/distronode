...
const RoleInstall = ({ namespace, name }: RoleMetaProps) => (
  <>
    ...
    <CopyURL url={`distronode-galaxy role install ${namespace}.${name}`} />
  </>
);
...
class DistronodeRoleDetail extends Component<RouteProps, RoleState> {
...
export default withRouter(DistronodeRoleDetail);
