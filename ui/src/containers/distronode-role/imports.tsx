...
class DistronodeRoleImports extends Component<RouteProps, IState> {
      ...
      <>
        ...
        <Main>
          <section className='body'>
            <div style={{ display: 'flex' }} data-cy='DistronodeRoleImports'>
...
export default withRouter(DistronodeRoleImports);
