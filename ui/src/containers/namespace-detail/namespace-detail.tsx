          ...
          {tab === 'cli-configuration' ? (
            <section className='body'>
              <div>
                <div>
                  <Trans>
                    <b>Note:</b> Use this URL to configure distronode-galaxy to
                    upload collections to this namespace. More information on
                    distronode-galaxy configurations can be found{' '}
                    <ExternalLink href='https://docs.distronode.com/distronode/latest/galaxy/user_guide.html#configuring-the-distronode-galaxy-client'>
                      here
                    </ExternalLink>
                    .
                  </Trans>
          ...
          {tab === 'access' ? (
            <section className='body'>
              <AccessTab
                ...
                name={namespace.name}
                pulpObjectType='pulp_distronode/namespaces'
