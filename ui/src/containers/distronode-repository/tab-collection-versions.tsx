...
import {
  distronodeRepositoryCollectionVersionAddAction,
  distronodeRepositoryCollectionVersionRemoveAction,
} from 'src/actions';
import {
...
export const CollectionVersionsTab = ({
  ...
  return (
    <DetailList<CollectionVersionSearch>
      ...
      headerActions={[distronodeRepositoryCollectionVersionAddAction]}
      listItemActions={[distronodeRepositoryCollectionVersionRemoveAction]}
      noDataButton={distronodeRepositoryCollectionVersionAddAction.button}
