...
import { canRevertDistronodeRepositoryVersion } from 'src/permissions';
...
function revert(
  ...
  return DistronodeRepositoryAPI.revert(pulpId, pulp_href)
    .then(({ data }) => {
      addAlert(
        taskAlert(
          data.task,
...
export const distronodeRepositoryVersionRevertAction = Action({
  condition: canRevertDistronodeRepositoryVersion,
