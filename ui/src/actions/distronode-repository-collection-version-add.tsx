...
const add = (
  ...
  return DistronodeRepositoryAPI.addContent(pulpId, collectionVersionHrefs)
    .then(({ data }) => {
      collections.map(
...
const AddCollectionVersionModal = ({
  ...
  closeAction: () => void;
  sourceRepository: DistronodeRepositoryType;
}) => {
...
export const distronodeRepositoryCollectionVersionAddAction = Action({
