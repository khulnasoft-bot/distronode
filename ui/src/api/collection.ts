...
export class API extends HubAPI {
  ...
  async setDeprecation({
    ...
    return this.patch(
      ...
      `v3/plugin/distronode/content/${distroBasePath}/collections/index/`,
    );
  }
  ...
  upload(
    ...
    if (data.distro_base_path) {
      return this.http.post(
        `v3/plugin/distronode/content/${data.distro_base_path}/collections/artifacts/`,
        formData,
        config,
      );
    } else {
  ...
  async getDownloadURL(repository, namespace, name, version) {
    ...
    return this.http
      .get(
        `v3/plugin/distronode/content/${distroBasePath}/collections/index/${namespace}/${name}/versions/${version}/`,
      )
  ...
  async deleteCollection({
    ...
    return this.http.delete(
      `v3/plugin/distronode/content/${distroBasePath}/collections/index/${namespace}/${name}/`,
    );
  }
