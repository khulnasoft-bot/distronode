...
import { type DistronodeRemoteType } from './response-types/distronode-remote';

// simplified version of smartUpdate from execution-environment-registry
function smartUpdate(
  remote: DistronodeRemoteType,
  unmodifiedRemote: DistronodeRemoteType,
) {
...
class API extends PulpAPI {
  apiPath = 'remotes/distronode/collection/';

  // create(data)
  // delete(uuid)
  // list(params?)

  smartUpdate(pk, newValue: DistronodeRemoteType, oldValue: DistronodeRemoteType) {
...
export const DistronodeRemoteAPI = new API();
