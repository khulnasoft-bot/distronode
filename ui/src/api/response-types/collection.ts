...
export class CollectionVersionSearch {
  ...
  is_highest: boolean;
  is_signed: boolean;
  // TODO: distronode namespace metadata doesn't work yet
  // assuming fields from pulp_distronode/NamespaceSummarySerializer
  namespace_metadata?: {
    pulp_href: string;
    name: string;
    company: string;
