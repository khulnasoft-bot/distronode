...
export const translateTask = (name) =>
  ({
    ...
    'pulp_distronode.app.tasks.collections.collection_sync': t`Collections sync`,
    'pulp_distronode.app.tasks.collections.import_collection': t`Import collection`,
    'pulp_distronode.app.tasks.collections.sync': t`Collections sync`,
    'pulp_distronode.app.tasks.collections.update_collection_remote': t`Update collection remote`,
    'pulp_distronode.app.tasks.copy.copy_content': t`Copy content`,
    'pulp_distronode.app.tasks.roles.synchronize': t`Roles synchronize`,
