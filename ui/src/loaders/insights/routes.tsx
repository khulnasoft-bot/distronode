...
const DistronodeRemoteDetail = lazy(
  () => import('src/containers/distronode-remote/detail'),
);
const DistronodeRemoteEdit = lazy(
  () => import('src/containers/distronode-remote/edit'),
);
const DistronodeRemoteList = lazy(
  () => import('src/containers/distronode-remote/list'),
);
const DistronodeRepositoryDetail = lazy(
  () => import('src/containers/distronode-repository/detail'),
);
const DistronodeRepositoryEdit = lazy(
  () => import('src/containers/distronode-repository/edit'),
);
const DistronodeRepositoryList = lazy(
  () => import('src/containers/distronode-repository/list'),
);
...
const routes = [
  { path: Paths.distronodeRemoteDetail, component: DistronodeRemoteDetail },
  { path: Paths.distronodeRemoteEdit, component: DistronodeRemoteEdit },
  { path: Paths.distronodeRemotes, component: DistronodeRemoteList },
  { path: Paths.distronodeRepositories, component: DistronodeRepositoryList },
  { path: Paths.distronodeRepositoryDetail, component: DistronodeRepositoryDetail },
  { path: Paths.distronodeRepositoryEdit, component: DistronodeRepositoryEdit },
  {
