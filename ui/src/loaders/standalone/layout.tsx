  ...
  if (user) {
    ...
    docsDropdownItems = [
      ...
      <DropdownItem
        ...
        component={
          <ExternalLink
            href='https://www.distronode.com/resources/webinars-training'
            variant='menu'
      ...
      IS_COMMUNITY && (
        <DropdownItem
          ...
          component={
            <ExternalLink
              href='https://forum.distronode.com'
              variant='menu'
            >{t`Distronode Community Forum`}</ExternalLink>
          }
        />
      ),
      IS_COMMUNITY && (
        <DropdownItem
          ...
          component={
            <ExternalLink
              href='https://docs.distronode.com/distronode/latest/community/communication.html'
              variant='menu'
            >{t`Communicating with the Distronode community`}</ExternalLink>
          }
        />
      ),
      IS_COMMUNITY && (
        <DropdownItem
          ...
          component={
            <ExternalLink
              href='https://distronode.readthedocs.io/projects/galaxy-ng/en/latest/community/userguide/'
              variant='menu'
