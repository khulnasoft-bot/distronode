...
import {
  DistronodeRemoteDetail,
  DistronodeRemoteEdit,
  DistronodeRemoteList,
  DistronodeRepositoryDetail,
  DistronodeRepositoryEdit,
  DistronodeRepositoryList,
  DistronodeRoleDetail,
  DistronodeRoleImport,
  DistronodeRoleImports,
  DistronodeRoleList,
  DistronodeRoleNamespaceDetail,
  DistronodeRoleNamespaceList,
  DistronodeRoleSync,
...
export class StandaloneRoutes extends Component<IRoutesProps> {
  ...
  getRoutes(): IRouteConfig[] {
    ...
    return [
      ...
      { component: DistronodeRoleDetail, path: Paths.standaloneRole },
      { component: DistronodeRoleImport, path: Paths.standaloneRoleImport },
      { component: DistronodeRoleImports, path: Paths.standaloneImports },
      { component: DistronodeRoleList, path: Paths.standaloneRoles },
      {
        component: DistronodeRoleNamespaceDetail,
        path: Paths.standaloneNamespace,
      },
      { component: DistronodeRoleNamespaceList, path: Paths.standaloneNamespaces },
      { component: DistronodeRoleSync, path: Paths.standaloneRoleSync },
      {
      ...
      { component: DistronodeRemoteDetail, path: Paths.distronodeRemoteDetail },
      { component: DistronodeRemoteEdit, path: Paths.distronodeRemoteEdit },
      { component: DistronodeRemoteList, path: Paths.distronodeRemotes },
      {
        component: DistronodeRepositoryDetail,
        path: Paths.distronodeRepositoryDetail,
      },
      {
        component: DistronodeRepositoryEdit,
        path: Paths.distronodeRepositoryEdit,
      },
      { component: DistronodeRepositoryList, path: Paths.distronodeRepositories },
