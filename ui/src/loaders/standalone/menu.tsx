...
import {
  canViewDistronodeRemotes,
  canViewDistronodeRepositories,
  isLoggedIn,
  ...
  return [
    ...
    menuSection(t`Collections`, {}, [
      ...
      menuItem(t`Repositories`, {
        ...
        url: formatPath(Paths.distronodeRepositories),
      }),
      menuItem(t`Remotes`, {
        condition: canViewDistronodeRemotes,
        url: formatPath(Paths.distronodeRemotes),
      }),
      ...
      menuItem(t`Approval`, {
        condition: (context) =>
          hasPermission(context, 'distronode.modify_distronode_repo_content'),
    ...
    menuItem(t`Documentation`, {
      url: 'https://distronode.readthedocs.io/projects/galaxy-ng/en/latest/community/userguide/',
      external: true,
      condition: ({ settings, user }) =>
        IS_COMMUNITY &&
        (settings.GALAXY_ENABLE_UNAUTHENTICATED_COLLECTION_ACCESS ||
