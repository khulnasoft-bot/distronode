...
import { DistronodeRepositoryAPI, type DistronodeRepositoryType } from 'src/api';
import {
  type AlertType,
  AppliedFilters,
  CheckboxRow,
...
interface IProps {
  ...
  selectedRepos: DistronodeRepositoryType[];
  setSelectedRepos: (selectedRepos: DistronodeRepositoryType[]) => void;
...
export const MultipleRepoSelector = (props: IProps) => {
  ...
  const [repositoryList, setRepositoryList] = useState<DistronodeRepositoryType[]>(
    [],
  );
