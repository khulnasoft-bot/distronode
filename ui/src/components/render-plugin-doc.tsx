...
// https://docs.distronode.com/distronode/latest/dev_guide/developing_modules_documenting.html
...
export class RenderPluginDoc extends Component<IProps, IState> {
        ...
        <Table className='hub-doc-options-table'>
          <Tbody>
            ...
            </Tr>
            {
              ...
              //https://github.com/distronode/distronode/blob/devel/lib/distronode/modules/network/fortios/fortios_dlp_fp_doc_source.py#L93}
  ...
  // https://github.com/distronode/distronode/blob/1b8aa798df6f6fa96ba5ea2a9dbf01b3f1de555c/hacking/build_library/build_distronode/jinja2/filters.py#L53
