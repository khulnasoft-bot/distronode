...
export const CollectionInfo = ({
  ...
  let installCommand = `distronode-galaxy collection install ${collection_version.namespace}.${collection_version.name}`;
  ...
  return (
    <div className='pf-v5-c-content info-panel'>
      ...
      <Grid hasGutter>
        ...
        <GridItem>
          <Split hasGutter>
            ...
            <SplitItem isFilled>
              ...
              <div>
                <Trans>
                  <b>Note:</b> Installing collections with distronode-galaxy is
                  only supported in distronode-core&gt;=2.13.9
                </Trans>
              </div>
            </SplitItem>
          </Split>
        ...
        />
        {content?.requires_distronode && (
          <GridItem>
            <Split hasGutter>
              <SplitItem className='install-title'>{t`Requires Distronode`}</SplitItem>
              <SplitItem isFilled data-cy='distronode-requirement'>
                {content?.requires_distronode}
              </SplitItem>
            </Split>
          </GridItem>
