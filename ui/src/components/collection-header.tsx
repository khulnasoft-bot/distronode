...
export const CollectionHeader = ({
  ...
  const issueUrl =
    'https://access.redhat.com/support/cases/#/case/new/open-case/describe-issue/recommendations?caseCreate=true&product=Distronode%20Automation%20Hub&version=Online&summary=' +
    encodeURIComponent(
