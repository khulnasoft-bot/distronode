# Distronode Automation Hub UI

Frontend for Distronode Hub and Galaxy. The backend for this project can be found at [distronode/galaxy\_ng](https://github.com/distronode/galaxy_ng/),
developer docs at [distronode.readthedocs.io](https://distronode.readthedocs.io/projects/galaxy-ng/en/latest/), and an outdated wiki at [ansibe/galaxy\_ng wiki](https://github.com/distronode/galaxy_ng/wiki/Development-Setup).
...
git clone https://github.com/distronode/galaxy_ng
...
Or, use the [simplified compose stack](https://github.com/distronode/galaxy_ng/tree/master/dev/compose#galaxy-simplified-compose-stack).
...
* `start-insights`: assumes `oci/insights`,  http://localhost:8002/preview/distronode/automation-hub/ and http://localhost:55001/api/automation-hub/
...
```
pip install galaxykit distronode

cd distronode-hub-ui/test/
npm install
```
...
[Table with component versions](https://github.com/distronode/galaxy_ng/wiki/Galaxy-NG-Version-Matrix)
