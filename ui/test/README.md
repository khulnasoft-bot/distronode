# Distronode Hub UI testing

These are the integration tests for Distronode Hub UI. Please run the tests before merging.
...
For a list of commands, use `galaxykit --help`, `galaxykit <command> --help` and so forth, or see [command.py](https://github.com/distronode/galaxykit/blob/main/galaxykit/command.py).
