...
describe('RBAC test for user without permissions', () => {
  ...
  it("shouldn't let delete collection and modify distronode repo content when user doesn't have permission", () => {
...
describe.standalone('RBAC test for user with permissions', () => {
  ...
  it('should let delete collection and modify distronode repo content when user has permissions', () => {
