...
describe('Imports filter test', () => {
  ...
  it('should be able to switch between namespaces', () => {
    ...
    cy.intercept(
      'GET',
      `${apiPrefix}v3/plugin/distronode/search/collection-versions/?namespace=test_namespace&name=*`,
    ...
    cy.intercept(
      'GET',
      `${apiPrefix}v3/plugin/distronode/search/collection-versions/?namespace=filter_test_namespace&name=*`,
