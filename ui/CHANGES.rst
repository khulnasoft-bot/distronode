...
- Change Wisdom Modal and legacy namespaces menu, rename to Distronode Lightspeed
...
- Replaced existing collection search with pulp_distronode collection version search endpoint
  `AAH-767 <https://issues.redhat.com/browse/AAH-767>`_
- Display Distronode Automation Platform version
...
- Fix an error where images created by distronode builder couldn't be inspected in the UI.
