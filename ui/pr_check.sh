...
export IMAGE_FRONTEND="quay.io/cloudservices/distronode-hub-ui"
...
export IMAGE_BACKEND_TAG=$(curl -s https://api.github.com/repos/distronode/galaxy_ng/commits/master | jq -r '.sha' | head -c7)
...
git clone https://github.com/distronode/galaxy_ng.git
cd galaxy_ng
