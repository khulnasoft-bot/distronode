...
export HUB_API_ROOT="https://galaxy-stage.distronode.com/api/"
...
pytest --log-cli-level=DEBUG -m "galaxy_stage_distronode" --junitxml=galaxy_ng-results.xml -v galaxy_ng/tests/integration
