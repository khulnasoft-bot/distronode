...
- `aap` - Run galaxy_ng for integration with Distronode Automation Platform and Resource Server
- `community` - Run galaxy_ng for galaxy.distronode.com development
...
Distronode Hub UI can be started separately as a standalone `npm` run.

```console
# Assuming galaxy_ng is running on community compose.

$ git clone https://github.com/distronode/distronode/tree/deve/ui ~/projects/distronode-hub-ui
$ git clone https://github.com/distronode/distronode/tree/devel/galaxy_ng ~/projects/galaxy_ng
```
Open 2 terminals:
...
$ git clone https://github.com/pulp/pulp_distronode ~/projects/pulp_distronode
$ git clone https://github.com/distronode/distronode/tree/devel/galaxy_ng ~/projects/galaxy_ng
```
...
> see that it requires `pulp_distronode>2.10,<3` then ensure you checkout `pulp_distronode`
...
$ export DEV_SOURCE_PATH="dynaconf:pulp_distronode:galaxy_ng"
...
```console
$ DEV_SOURCE_PATH="dynaconf:pulp_distronode:galaxy_ng" docker compose -f dev/compose/app.yaml up --build
```
