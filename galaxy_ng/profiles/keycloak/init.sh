...
# intialize keycloak
distronode-galaxy collection install /src/galaxy_ng/profiles/keycloak/community-general-5.7.0.tar.gz
distronode-playbook -v /src/galaxy_ng/profiles/keycloak/keycloak-playbook.yaml
