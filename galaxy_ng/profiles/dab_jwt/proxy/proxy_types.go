...
/*
pulp-1          | {'aud': 'distronode-services',
pulp-1          |  'exp': 1718658788,
pulp-1          |  'global_roles': [],
pulp-1          |  'iss': 'distronode-issuer',
pulp-1          |  'object_roles': {'Team Member': {'content_type': 'team', 'objects': [0]}},
pulp-1          |  'objects': {'organization': [{'distronode_id': 'bc243368-a9d4-4f8f-9ffe-5d2d921fcee5',
pulp-1          |                                'name': 'Default'}],
pulp-1          |              'team': [{'distronode_id': '34a58292-1e0f-49f0-9383-fb7e63d771d9',
pulp-1          |                        'name': 'ateam',
pulp-1          |                        'org': 0}]},
