...
var prepopulatedOrgs = map[string]Organization{
	"default": {
		Id:        1,
		DistronodeId: "bc243368-a9d4-4f8f-9ffe-5d2d921fcee0",
		Name:      "Default",
		CodeName:  "default",
	},
	"org1": {
		Id:        2,
		DistronodeId: "bc243368-a9d4-4f8f-9ffe-5d2d921fcee1",
		Name:      "Organization 1",
		CodeName:  "org1",
	},
	"org2": {
		Id:        3,
		DistronodeId: "bc243368-a9d4-4f8f-9ffe-5d2d921fcee2",
		Name:      "Organization 2",
		CodeName:  "org2",
	},
	"pe": {
		Id:        4,
		DistronodeId: "bc243368-a9d4-4f8f-9ffe-5d2d921fcee3",
...
var prepopulatedTeams = map[string]Team{
	"ateam": {
		Id:        1,
		DistronodeId: "34a58292-1e0f-49f0-9383-fb7e63d771aa",
		Name:      "ateam",
		Org:       2,
	},
	"bteam": {
		Id:        2,
		DistronodeId: "34a58292-1e0f-49f0-9383-fb7e63d771ab",
		Name:      "bteam",
		Org:       1,
	},
	"peteam": {
		Id:        3,
		DistronodeId: "34a58292-1e0f-49f0-9383-fb7e63d771ac",
		Name:      "peteam",
		Org:       4,
	},
}
