	...
	/*
		...
		# RESPONSE
		{
			...
			"summary_fields":{
				...
				"resource":{"distronode_id":"5fc36ea7-5c54-4f12-b47c-5213d648b2c0","resource_type":"shared.user"}
			},
...
func deleteUser(w http.ResponseWriter, r *http.Request) {
	...
	ruser, _ := GetRequestUser(r)
	client := NewServiceIndexClient()
	if err := client.Delete(ruser, distronodeId); err != nil {
