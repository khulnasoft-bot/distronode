/*************************************************************
    ...
    distronode_base.jwt_consumer.hub.auth.HubJWTAuth from
    ...
    backwards compatibility for distronode-galaxy cli clients
...
var DISTRONODE_BASE_SHARED_SECRET = "redhat1234"
