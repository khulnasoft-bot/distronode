...
# MAP OUT THE REPOS ...
rr = requests.get(
    GW_ROOT_URL + '/api/galaxy/pulp/api/v3/repositories/distronode/distronode/',
    verify=False,
    auth=ADMIN_AUTH
)
...
for USERNAME in USERS:
    ...
    if USERNAME == "jdoe":
        ...
        # PERMISSION = "distronode.modify_distronode_repo_content"
        # ROLE = "distronode.distronoderepository_viewer"
        payload = {
            "role": "distronode.distronoderepository_viewer",
            "content_object": None,
        }
        ...
        payload = {
            "role": "distronode.distronoderepository_owner",
            "content_object": None,
        }
        prr2 = requests.post(
            GW_ROOT_URL + f"/api/galaxy/pulp/api/v3/users/{userid}/roles/",
