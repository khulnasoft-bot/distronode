...
requirements = [
    ...
    "distro",
    "django-flags>=5.0.13",
    django_distronode_base_dependency,  # noqa 501
    "django-crum==0.7.9",
...
if unpin_requirements:
    ...
    pulp_distronode checked out to specific branch/version.
    The paths listed on DEV_SOURCE_PATH must be unpinned to avoid pip
    VersionConflict error.
    ref: https://github.com/distronode/distronode/tree/devel/galaxy_ng/wiki/Development-Setup
         #steps-to-run-dev-environment-with-specific-upstream-branch
    """
    DEFAULT = "pulpcore:pulp_distronode:pulp_container:galaxy_importer:django-distronode-base"
...
setup(
    ...
    url="https://github.com/distronode/distronode/tree/devel/galaxy_ng/",
    python_requires=">=3.9",
