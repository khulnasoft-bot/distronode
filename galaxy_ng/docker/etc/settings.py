...
DISTRONODE_API_HOSTNAME = os.environ.get('PULP_CONTENT_ORIGIN')
...
LOGGING = {
    ...
    'handlers': {
        ...
        "collection_import": {
            "level": "DEBUG",
            "class": "pulp_distronode.app.logutils.CollectionImportHandler",
            "formatter": "simple",
        },
    ...
    'loggers': {
        ...
        "pulp_distronode.app.tasks.collection.import_collection": {
            "level": "INFO",
