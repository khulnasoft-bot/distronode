...
```                                                                 
[galaxy-importer]                                                                                                                        
distronode_local_tmp=~/.distronode/tmp                                                                                                         
distronode_test_local_image=false                                      
...
run_distronode_doc=false                                               
run_distronode_lint=false                                              
run_distronode_test=false                                              
run_flake8=false                                                    
```
...
https://github.com/distronode/galaxy-importer/blob/master/galaxy_importer/config.py#L43-L57

If you want to run galaxy-importer standalone, check the [README.md](https://github.com/distronode/galaxy-importer/blob/master/README.md)
...
PULP_DISTRONODE_API_HOSTNAME=http://localhost:8080
PULP_GALAXY_API_PATH_PREFIX=/api/galaxy/                            
PULP_DISTRONODE_CONTENT_HOSTNAME=http://localhost:8080/pulp/content/api/galaxy/v3/artifacts/collections/
...
PULP_GALAXY_COLLECTION_SIGNING_SERVICE=distronode-default              
