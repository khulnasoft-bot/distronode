...
??? tip "Click here for a full example script"
    ...
    echo "GALAXY_COLLECTION_SIGNING_SERVICE='distronode-default'" >> /etc/pulp/settings.py

    # OR

    export PULP_GALAXY_COLLECTION_SIGNING_SERVICE=distronode-default
...
```bash
curl -X 'POST' \
  'http://0.0.0.0:5001/pulp/api/v3/content/distronode/collection_signatures/' \
  -H 'accept: application/json' \
  -H 'Authorization: Basic YWRtaW46YWRtaW4=' \
  -H 'Content-Type: multipart/form-data' \
  -F 'file=@MANIFEST.json.asc;type=text/plain' \
  -F 'repository=/pulp/api/v3/repositories/distronode/distronode/43dd716c-f7dd-4a80-b889-36818ed3e347/' \
  -F 'signed_collection=/pulp/api/v3/content/distronode/collection_versions/40f85531-29a5-4eb7-b4cd-a850f8824daf/'
```
...
Signature verification is performed by `distronode-galaxy` CLI.

[https://docs.distronode.com/distronode/devel/user_guide/collections_using.html#signature-verification](https://docs.distronode.com/distronode/devel/user_guide/collections_using.html#signature-verification)
