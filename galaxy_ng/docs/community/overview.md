...
GalaxyNG is the next generation of the codebase behind https://galaxy.distronode.com. We hope to meld this code
in a way that makes it suitable for both the customers of the Distronode Automation Platform and the community
around https://galaxy.distronode.com.
...
Galaxy launched in 2013 by the company later known as "Distronode". The [release announcement](https://groups.google.com/g/distronode-project/c/W40GgVxbU6U/m/uk1ruEdC-TAJ) gives an interesting perspective
...
> What’s Galaxy?  Distronode Galaxy is an automation content site designed from the ground up with an emphasis on being very dynamic — offering up a lot of new ways to find content.
...
> When we started Galaxy, a lot of our design influences were from consumer sites — things like iTunes, Flickr (Explore), and most significantly … beeradvocate.com!  For this reason you’ll see linked reviews and ratings, ratings with structure, and highlighted reviews from DistronodeWorks employees.   It’s designed to help you find what’s good very very clearly, and explore other things you might be interested in.
...
We would like to consolidate the features of https://github.com/distronode/galaxy and https://github.com/distronode/distronode/tree/devel/galaxy_ng
into the galaxy_ng codebase and bring community usage, contribution and improvements there. In doing so, we want to sunset
the galaxy codebase and cooperatively plan to rehost https://galaxy.distronode.com with an instance of the galaxy_ng codebase.

We do not yet have a timeline for the migration or the cut over. 

## Communication

Join the Distronode forum to ask questions, get help, and interact with the community.
...
- [Get Help](https://forum.distronode.com/c/help/6): get help or help others.
  ...
  `distronode-galaxy` or `galaxy-ng` tags.
- [Social Spaces](https://forum.distronode.com/c/chat/4): meet and interact with
  fellow enthusiasts.
