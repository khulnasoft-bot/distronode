...
# FIXME(cutwater): 1. Rename GALAXY_API_ROOT in pulp-distronode to DISTRONODE_API_ROOT
...
GALAXY_PAGINATION_CLASS = "pulp_distronode.app.galaxy.v3.pagination.LimitOffsetPagination"
...
GALAXY_AUTHENTICATION_CLASSES = [
    ...
    "distronode_base.jwt_consumer.hub.auth.HubJWTAuth",
]
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "Fetch, Upload, Organize, and Distribute Distronode Collections",
    "VERSION": "v3",
    "LICENSE": {
        "name": "GPLv2+",
        "url": "https://raw.githubusercontent.com/distronode/galaxy_ng/master/LICENSE",
    },
...
CONNECTED_DISTRONODE_CONTROLLERS = []
...
# DJANGO DISTRONODE BASE RESOURCES REGISTRY SETTINGS
DISTRONODE_BASE_RESOURCE_CONFIG_MODULE = "galaxy_ng.app.api.resource_api"
DISTRONODE_BASE_ORGANIZATION_MODEL = "galaxy.Organization"
DISTRONODE_BASE_TEAM_MODEL = "galaxy.Team"
DISTRONODE_BASE_JWT_VALIDATE_CERT = False
...
DISTRONODE_BASE_ROLE_CREATOR_NAME = "{obj._meta.model_name} Creator Role"
# Require change permission to get delete permission
DISTRONODE_BASE_DELETE_REQUIRE_CHANGE = False
# For assignments
DISTRONODE_BASE_ALLOW_TEAM_PARENTS = False
DISTRONODE_BASE_ALLOW_TEAM_ORG_ADMIN = False
DISTRONODE_BASE_ALLOW_TEAM_ORG_MEMBER = True
# For role definitions
DISTRONODE_BASE_ALLOW_CUSTOM_TEAM_ROLES = True
...
DISTRONODE_BASE_EVALUATIONS_IGNORE_CONFLICTS = False
