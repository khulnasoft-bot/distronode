...
from pulp_distronode.app import models as pulp_models
from pulp_distronode.app.tasks.collections import sync as collection_sync
...
class SyncRemoteView(api_base.APIView):
    ...
    def post(self, request: Request, *args, **kwargs) -> Response:
        ...
        distro = get_object_or_404(pulp_models.DistronodeDistribution, base_path=distro_path)
        ...
        remote = distro.repository.remote.distronode_collectionremote
