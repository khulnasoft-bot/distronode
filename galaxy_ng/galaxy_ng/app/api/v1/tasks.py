...
def legacy_role_import(
    ...
    with tempfile.TemporaryDirectory() as tmp_path:
        ...
        if alternate_role_name:
            ...
            role_name = github_repo.replace("distronode-role-", "")
        ...
        new_full_metadata = {
            ...
            'min_distronode_version': galaxy_info["min_distronode_version"] or "",
            'min_distronode_container_version': galaxy_info["min_distronode_container_version"] or "",
...
def legacy_sync_from_upstream(
    ...
    This is conceptually similar to the pulp_distronode/app/tasks/roles.py:synchronize
    ...
    for ns_data, rdata, rversions in upstream_role_iterator(**iterator_kwargs):
        ...
        role_min_distronode = rdata.get('min_distronode_version')
        ...
        new_full_metadata = {
            ...
            'min_distronode_version': role_min_distronode,
