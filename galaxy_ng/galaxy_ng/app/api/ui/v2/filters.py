...
class OrganizationFilter(django_filters.FilterSet):
    resource__distronode_id = django_filters.CharFilter(
        field_name="resource__distronode_id", lookup_expr="exact"
    )

    class Meta:
        model = Organization
        fields = [
            "resource__distronode_id",
            "name",
        ]
