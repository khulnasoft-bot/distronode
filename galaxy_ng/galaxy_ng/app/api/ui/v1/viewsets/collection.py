...
from pulp_distronode.app.galaxy.v3 import views as pulp_distronode_galaxy_views
from pulp_distronode.app import viewsets as pulp_distronode_viewsets
from pulp_distronode.app.models import (
    DistronodeCollectionDeprecated,
...
class CollectionByCollectionVersionFilter(pulp_distronode_viewsets.CollectionVersionFilter):
    """pulp_distronode CollectionVersion filter for Collection viewset."""
...
class CollectionViewSet(
    ...
    pulp_distronode_galaxy_views.DistronodeDistributionMixin,
):
    ...
    def get_queryset(self):
        ...
        deprecated_query = DistronodeCollectionDeprecated.objects.filter(
...
class CollectionVersionFilter(filterset.FilterSet):
    ...
    def repo_filter(self, queryset, name, value):
        try:
            distro = DistronodeDistribution.objects.get(base_path=value)
...
class CollectionImportViewSet(api_base.GenericViewSet,
                              pulp_distronode_galaxy_views.CollectionImportViewSet):
