...
class DistributionViewSet(
    ...
    model = pulp_models.DistronodeDistribution
    queryset = pulp_models.DistronodeDistribution.objects.exclude(
...
class MyDistributionViewSet(DistributionViewSet):
    ...
    def get_queryset(self):
        ...
        return pulp_models.DistronodeDistribution.objects.filter(
