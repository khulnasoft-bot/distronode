...
class CollectionSignView(api_base.APIView):
    ...
    def _get_content_units_to_sign(self, request, repository):
        ...
        if request.data.get("content_units"):
            ...
            query_params = {
                "pulp_type": "distronode.collection_version",
                "distronode_collectionversion__namespace": namespace,
            }
            ...
            if collection:
                query_params["distronode_collectionversion__name"] = collection
            if version:
                query_params["distronode_collectionversion__version"] = version
    ...
    def get_repository(self, request):
        ...
        try:
            return DistronodeDistribution.objects.get(base_path=distro_name).repository
