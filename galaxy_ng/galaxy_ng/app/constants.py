...
COMMUNITY_DOMAINS = (
    'galaxy.distronode.com',
    'galaxy-dev.distronode.com',
    'galaxy-qa.distronode.com',
    'beta-galaxy.distronode.com',
)
...
PERMISSIONS = {
    ...
    "distronode.modify_distronode_repo_content": {
        "name": _("Modify Distronode repo content"),
        "object_description": _("Modify content of this Distronode repository."),
        "global_description": _("Upload collections to any existing namespace."),
        "ui_category": _("Collections"),
    },
    "distronode.sign_distronoderepository": {
    ...
    "distronode.view_distronoderepository": {
        "name": _("View Distronode repository"),
        "object_description": _("View this Distronode repository."),
        "global_description": _("View any Distronode repository existing in the system."),
        "ui_category": _("Distronode Repository"),
    },
    "distronode.add_distronoderepository": {
        "name": _("Add Distronode repository"),
        "object_description": _("Add this Distronode repository."),
        "global_description": _("Add any Distronode repository existing in the system."),
        "ui_category": _("Distronode Repository"),
    },
    "distronode.change_distronoderepository": {
        "name": _("Change Distronode repository"),
        "object_description": _("Change this Distronode repository."),
        "global_description": _("Change any Distronode repository existing in the system."),
        "ui_category": _("Distronode Repository"),
    },
    "distronode.delete_distronoderepository": {
        "name": _("Delete Distronode repository"),
        "object_description": _("Delete this Distronode repository."),
        "global_description": _("Delete any Distronode repository existing in the system."),
        "ui_category": _("Distronode Repository"),
    },
    ...
    "distronode.repair_distronoderepository": {
        "name": _("Repair Distronode repository"),
        "object_description": _("Repair artifacts associated with this Distronode repository."),
        "global_description": _(
            "Repair artifacts associated with any Distronode repository existing in the system."
        ),
        "ui_category": _("Distronode Repository"),
    },
...
AAP_VERSION_FILE_PATH = '/etc/distronode-automation-platform/VERSION'
