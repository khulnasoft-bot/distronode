# Pulp distronode has the collections api broken down into a bunch of separate viewsets
...
_collection_statements = [
    ...
    },
    {
        ...
        "effect": "allow",
        "condition": [
            "has_model_perms:distronode.modify_distronode_repo_content", "v3_can_view_repo_content"]
    },
    {
        "action": "sign",
        "principal": "authenticated",
...
STANDALONE_STATEMENTS = {
    ...
    'CollectionRemoteViewSet': [
        ...
        },
        {
            ...
            "principal": "authenticated",
            "effect": "allow",
            "condition": "has_model_perms:distronode.change_collectionremote"
        }
    ],
