...
from pulp_distronode.app.models import DistronodeNamespaceMetadata
...
class Namespace(
    ...
    """
    A model representing Distronode content namespace.
    ...
    def avatar_url(self):
        ...
        if settings.GALAXY_DEPLOYMENT_MODE == DeploymentMode.STANDALONE.value:  # noqa: SIM300
            ...
            if data and data.avatar_sha256:
                return settings.DISTRONODE_API_HOSTNAME + get_url(data) + "avatar/"
