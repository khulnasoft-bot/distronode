...
from pulp_distronode.app.models import DistronodeRepository, CollectionVersion
...
def _upload_collection(**kwargs):
    ...
    try:
        repo = DistronodeRepository.objects.get(pk=repo_pk)
    except DistronodeRepository.DoesNotExist:
    ...
    # pulp_distronode.app.serializers.CollectionVersionUploadSerializer serializer
    # Example structure:
    #   args: [distronode, CollectionVersionUploadSerializer]
    #   kwargs:
