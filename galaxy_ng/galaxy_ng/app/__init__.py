...
def add_required_dab_attributes_to_models():
    ...
    """
    from distronode_base.rbac import models as dab_rbac_models
    ...
    from pulp_distronode.app import models as pulp_distronode_models
    ...
    model_mapping = {
        ...
        pulp_distronode_models.DistronodeDistribution: {
            "summary_fields": common_summary_fields,
            "reverse_name": "distributions-distronode/distronode-detail"
        },
        pulp_distronode_models.DistronodeCollectionDeprecated: {
            "summary_fields": common_summary_fields,
            "reverse_name": "content-distronode/collection_deprecations-detail"
        },
        pulp_distronode_models.DistronodeNamespaceMetadata: {
            "summary_fields": common_summary_fields,
        },
        pulp_distronode_models.Tag: {
            "summary_fields": common_summary_fields,
        },
        pulp_distronode_models.DistronodeNamespace: {
            "summary_fields": common_summary_fields,
            "reverse_name": "pulp_distronode/namespaces-detail"
        },
        pulp_distronode_models.CollectionVersionSignature: {
            "summary_fields": ("pk", "pubkey_fingerprint"),
            "reverse_name": "content-distronode/collection_signatures-detail"
        },
        pulp_distronode_models.CollectionVersion: {
            "summary_fields": (*common_summary_fields, "version"),
            "reverse_name": "content-distronode/collection_versions-detail"
        },
        pulp_distronode_models.Collection: {
            "summary_fields": (*common_summary_fields, "namespace"),
            "reverse_name": "distronode/collections-detail"
        },
        pulp_distronode_models.CollectionRemote: {
            "summary_fields": common_summary_fields,
            "reverse_name": "remotes-distronode/collection-detail"
        },
        pulp_distronode_models.DistronodeRepository: {
            "summary_fields": common_summary_fields,
            "reverse_name": "repositories-distronode/distronode-detail"
        },
