...
from pulp_distronode.app.tasks.utils import parse_collections_requirements_file
...
class Command(BaseCommand):
    ...
    $ create-remote community https://galaxy.distronode.com -r /tmp/reqs.yaml
    ...
    def create_repository(self, data, remote):
        repository, repo_created = DistronodeRepository.objects.get_or_create(
    ...
    def create_distribution(self, data, remote, repository):
        ...
        distribution, distro_created = DistronodeDistribution.objects.get_or_create(name=distro_name)
