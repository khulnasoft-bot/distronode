...
@register("collections", "1.0", format="csv", description="Data on distronode_collection")
...
@register(
    ...
    "1.0",
    format="csv",
    description="Full sync: Data on distronode_collectionversion_tags"
)
...
@register(
    ...
    "1.0",
    format="csv",
    description="Data on distronode_tag"
)
...
@register(
    ...
    "1.0",
    format="csv",
    description="Data from distronode_downloadlog"
)
...
@register(
    ...
    "1.0",
    format="csv",
    description="Data from distronode_collectiondownloadcount"
)
