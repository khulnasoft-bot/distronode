...
from distronode_base.rbac.validators import permissions_allowed_for_role, combine_values
...
def create_permissions_as_operation(apps, schema_editor):
    ...
    for app_label in {'distronode', 'container', 'core', 'galaxy'}:
...
def migrate_role_assignments(apps, schema_editor):
    ...
    # galaxy_ng/app/settings.py - DISTRONODE_BASE_MANAGED_ROLE_REGISTRY
