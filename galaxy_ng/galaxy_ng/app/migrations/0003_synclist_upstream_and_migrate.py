...
def set_default_upstream_repository(apps, schema_editor):
    ...
    try:
        default_repo = DistronodeRepository.objects.using(db_alias).get(name="automation-hub")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('distronode', '0018_fix_collection_relative_path'),
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.ForeignKey(to='distronode.DistronodeRepository',
        ...
        migrations.AlterField(
            model_name='synclist',
            name='repository',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='repositories', to='distronode.DistronodeRepository'),
        ),
    ]
