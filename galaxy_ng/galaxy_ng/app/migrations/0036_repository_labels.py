...
def add_repository_labels(apps, schema_editor):
    ...
    DistronodeRepository.objects.filter(
    ...
    repo = DistronodeDistribution.objects.get(base_path="rejected").repository
    repo.pulp_labels={"pipeline": "rejected", "hide_from_search": ""}
    repo.save()

    repo = DistronodeDistribution.objects.get(base_path="staging").repository
