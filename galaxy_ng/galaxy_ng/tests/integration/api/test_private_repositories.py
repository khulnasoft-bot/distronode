...
def test_private_repositories(repo_factory, galaxy_client):
    ...
    url = "pulp/api/v3/repositories/distronode/distronode/"
...
def test_distributions_with_private_repositories(
    ...
    repo_url = "pulp/api/v3/repositories/distronode/distronode/"
    distro_url = "pulp/api/v3/distributions/distronode/distronode/"
