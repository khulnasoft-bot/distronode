...
class TestRepositories:
    ...
    def test_move_cv_endpoint(self, galaxy_client):
        ...
        # (http://localhost:38080/api/automation-hub/pulp/api/v3/repositories/distronode/distronode/):
        # Post "http://pulp:55001/api/automation-hub/pulp/api/v3/repositories/distronode/distronode/":
        ...
        # FIXME(jctanner): The POST call will often result in an error with the oci+insights profile
        # root:client.py:216 Cannot parse expected JSON response
        # (http://localhost:38080/api/<prefix>/pulp/api/v3/repositories/distronode/distronode/
        #   <uuid>/move_collection_version/):
        # Post "http://pulp:55001/api/<prefix>/pulp/api/v3/repositories/distronode/distronode/
        #   <uuid>/move_collection_version/":
