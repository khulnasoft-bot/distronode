...
def test_download_artifact(distronode_config, galaxy_client):
    ...
    with tempfile.TemporaryDirectory() as dir_:
        ...
        url = (f"{gc.galaxy_root}v3/plugin/distronode/content/"
...
@pytest.mark.all
def test_download_artifact_validated(distronode_config, galaxy_client):
    # gc = galaxy_client("partner_engineer")
