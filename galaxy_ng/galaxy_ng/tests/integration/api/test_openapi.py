...
PULPY_VARIABLES = [
    '{distronode_collection_href}',
    '{distronode_collection_version_href}',
    '{distronode_collection_import_href}',
    '{role_href}',
    '{task_group_href}',
    '{upload_href}',
    '{worker_href}'
...
@pytest.mark.all
def test_openapi_bindings_generation(distronode_config, galaxy_client):
