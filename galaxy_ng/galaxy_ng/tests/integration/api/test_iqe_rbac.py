...
class TestRBAC:
    ...
    def test_global_role_delete_collection(self, galaxy_client):
        ...
        gc = galaxy_client("admin")
        user, group = add_new_user_to_new_group(gc)
        permissions = ["distronode.delete_collection"]
        role_name = f"galaxy.rbac_test_role_{uuid4()}"
        gc.create_role(role_name, "any_description", permissions)
        gc.add_role_to_group(role_name, group["id"])
    ...
    def test_role_reject_collection(self, galaxy_client):
        ...
        gc = galaxy_client("admin")
        user, group = add_new_user_to_new_group(gc)
        permissions_user = ["distronode.modify_distronode_repo_content"]
    ...
    def test_user_role_remotes(self, galaxy_client):
        ...
        gc = galaxy_client("admin")
        user, group = add_new_user_to_new_group(gc)
        permissions_user = ["distronode.change_collectionremote"]
        role_user = f"galaxy.rbac_test_role_{uuid4()}"
        gc.create_role(role_user, "any_description", permissions_user)
        gc.add_role_to_group(role_user, group["id"])
        gc_user = galaxy_client(user)
    ...
    def test_user_role_get_remotes(self, galaxy_client):
        ...
        gc = galaxy_client("admin")
        user, group = add_new_user_to_new_group(gc)
        permissions = ["distronode.view_collectionremote"]
        role_user = f"galaxy.rbac_test_role_{uuid4()}"
        gc.create_role(role_user, "any_description", permissions)
        gc.add_role_to_group(role_user, group["id"])
        gc_user = galaxy_client(user)
    ...
    @pytest.mark.iqe_rbac_test
    def test_missing_object_role_push_image_to_ee(self, galaxy_client, distronode_config):
        """
        Verifies that when a user does not have
        object permissions to push an image, the user can't push an image
        """
        gc = galaxy_client("admin")
        ee_name = create_emtpy_local_image_container(distronode_config("admin"), gc)
        user, _ = add_new_user_to_new_group(gc)
        gc_user = galaxy_client(user)
    ...
    @pytest.mark.iqe_rbac_test
    def test_object_role_push_image_to_ee(self, galaxy_client, distronode_config):
        """
    ...
    @pytest.mark.iqe_rbac_test
    def test_global_role_push_image_to_ee(self, galaxy_client, distronode_config):
        """
    ...
    @pytest.mark.iqe_rbac_test
    def test_missing_global_role_push_image_to_ee(self, galaxy_client, distronode_config):
        """
        Verifies that when a user does not have
    ...
    @pytest.mark.iqe_rbac_test
    def test_missing_object_role_delete_image_from_ee(self, galaxy_client, distronode_config):
        """
        Verifies that when a user does not have
    ...
    @pytest.mark.iqe_rbac_test
    def test_global_role_delete_image_from_ee(self, galaxy_client, distronode_config):
        """
    ...
    @pytest.mark.iqe_rbac_test
    def test_missing_global_role_delete_image_from_ee(self, galaxy_client, distronode_config):
        """
        Verifies that when a user does not have
