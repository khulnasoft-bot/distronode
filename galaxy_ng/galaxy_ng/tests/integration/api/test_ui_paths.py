...
from distronode.galaxy.api import GalaxyError
...
def test_api_ui_v1_login(distronode_config):

    cfg = distronode_config("basic_user")
...
@pytest.mark.skip_in_gw
def test_api_ui_v1_login_cache_header(distronode_config):
...
@pytest.mark.api_ui
@pytest.mark.skip_in_gw
def test_api_ui_v1_logout(distronode_config):
...
@pytest.mark.api_ui
@pytest.mark.skip_in_gw
def test_api_ui_v1_collection_versions(distronode_config, uncertifiedv2):
...
@pytest.mark.api_ui
@pytest.mark.skip_in_gw
def test_api_ui_v1_collection_versions_version_range(distronode_config, uncertifiedv2):
...
@pytest.mark.skip_in_gw
def test_api_ui_v1_distributions(distronode_config):
    cfg = distronode_config('basic_user')
    with UIClient(config=cfg) as uclient:
...
@pytest.mark.min_hub_version("4.6dev")
@pytest.mark.skip_in_gw
def test_api_ui_v1_distributions_by_id(distronode_config):
    cfg = distronode_config('basic_user')
    with UIClient(config=cfg) as uclient:
...
@pytest.mark.api_ui
@pytest.mark.skip_in_gw
def test_api_ui_v1_execution_environments_registries(distronode_config):

    cfg = distronode_config('ee_admin')
    with UIClient(config=cfg) as uclient:
...
@pytest.mark.min_hub_version("4.6dev")
@pytest.mark.skip_in_gw
def test_api_ui_v1_feature_flags(distronode_config):
...
@pytest.mark.api_ui
@pytest.mark.skip_in_gw
def test_api_ui_v1_groups(distronode_config):

    cfg = distronode_config('partner_engineer')
    with UIClient(config=cfg) as uclient:
...
@pytest.mark.api_ui
@pytest.mark.skip_in_gw
def test_api_ui_v1_groups_users(distronode_config):
...
@pytest.mark.api_ui
@pytest.mark.skip_in_gw
def test_api_ui_v1_groups_users_add_delete(distronode_config):
...
@pytest.mark.api_ui
@pytest.mark.skip_in_gw
def test_api_ui_v1_groups_by_id(distronode_config):
...
@pytest.mark.api_ui
@pytest.mark.skip_in_gw
def test_api_ui_v1_imports_collections(distronode_config):
...
@pytest.mark.api_ui
@pytest.mark.skip_in_gw
def test_api_ui_v1_me(distronode_config, settings):
...
@pytest.mark.min_hub_version("4.6dev")
@pytest.mark.skip_in_gw
def test_api_ui_v1_my_namespaces(distronode_config, galaxy_client):
...
@pytest.mark.min_hub_version("4.6dev")
@pytest.mark.skip_in_gw
def test_api_ui_v1_my_namespaces_name(distronode_config):
    cfg = distronode_config('partner_engineer')
    with UIClient(config=cfg) as uclient:
        # get the response
...
@pytest.mark.api_ui
@pytest.mark.skip_in_gw
def test_api_ui_v1_remotes(distronode_config):
...
@pytest.mark.api_ui
@pytest.mark.skip_in_gw
def test_api_ui_v1_remotes_by_id(distronode_config):
...
@pytest.mark.api_ui
@pytest.mark.skip_in_gw
def test_api_ui_v1_repo_distro_by_basepath(distronode_config):
...
@pytest.mark.api_ui
@pytest.mark.skip_in_gw
def test_api_ui_v1_collection_detail_view(distronode_config, published):
...
@pytest.mark.skip_in_gw
def test_api_ui_v1_settings(distronode_config):
    ...
    with UIClient(config=cfg) as uclient:
        ...
        assert ds["DISTRONODE_BASE_ROLES_REQUIRE_VIEW"] in [True, False]
        assert ds["TOKEN_AUTH_DISABLED"] in [True, False]
        assert "DISTRONODE_API_HOSTNAME" in ds
        assert "DISTRONODE_CONTENT_HOSTNAME" in ds
...
@pytest.mark.api_ui
@pytest.mark.skip_in_gw
def test_api_ui_v1_tags(distronode_config):
...
def test_api_ui_v1_tags_collections(distronode_config, upload_artifact):
...
@pytest.mark.deployment_community
def test_api_ui_v1_tags_roles(distronode_config, docker_compose_exec):
...
@pytest.mark.api_ui
@pytest.mark.skip_in_gw
def test_api_ui_v1_users(distronode_config):
...
@pytest.mark.api_ui
@pytest.mark.skip_in_gw
def test_api_ui_v1_users_by_id(distronode_config):
...
@pytest.mark.api_ui
def test_users_list_insights_access(distronode_config):
...
@pytest.mark.deployment_cloud
@pytest.mark.api_ui
def test_users_detail_insights_access(distronode_config):
    """Check insights mode access to users endpoint"""
    ...
    admin_config = distronode_config("partner_engineer")
