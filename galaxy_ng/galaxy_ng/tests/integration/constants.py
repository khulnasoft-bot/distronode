...
USERNAME_ADMIN = "distronode-insights"
...
EPHEMERAL_PROFILES = {
    ...
    "basic_user": {
        "username": {"vault_path": "secrets/qe/stage/users/distronode-hub-qe-basic",
                     "vault_key": "username"},
        "password": {"vault_path": "secrets/qe/stage/users/distronode-hub-qe-basic",
                     "vault_key": "password"},
        "token": {"vault_path": "secrets/qe/stage/users/distronode-hub-qe-basic",
                  "vault_key": "token"},
    },
    # in partner engineer group, not an SSO org admin username: distronode-hub-qe-pe2
    "partner_engineer": {
        "username": {"vault_path": "secrets/qe/stage/users/distronode-hub-qe-pe",
                     "vault_key": "username"},
        "password": {"vault_path": "secrets/qe/stage/users/distronode-hub-qe-pe",
                     "vault_key": "password"},
        "token": {"vault_path": "secrets/qe/stage/users/distronode-hub-qe-pe",
                  "vault_key": "token"},
    },
    # an SSO org admin, not in partner engineer group
    "org_admin": {
        "username": {"vault_path": "secrets/qe/stage/users/distronode-hub-qe-rbac",
                     "vault_key": "username"},
        "password": {"vault_path": "secrets/qe/stage/users/distronode-hub-qe-rbac",
                     "vault_key": "password"},
        "token": None,
    },
...
SYNC_PROFILES = {
    "remote_admin": {
        "username": {"vault_path": "secrets/qe/stage/users/distronode_insights",
                     "vault_key": "username"},
        "password": {"vault_path": "secrets/qe/stage/users/distronode_insights",
                     "vault_key": "password"},
        "token": {"vault_path": "secrets/qe/stage/users/distronode_insights",
                  "vault_key": "token"},
    },
...
GALAXY_STAGE_DISTRONODE_PROFILES = {
