...
def test_community_collection_download_count_sync(distronode_config, docker_compose_exec):
    ...
    base_url = 'https://old-galaxy.distronode.com'
    ...
    while next_url:
        ...
        for collection in ds['results']:
            ...
            check_url = (
                '/api/v3/plugin/distronode/content/community'
    ...
    resp = api_client.request('/api/pulp/api/v3/remotes/distronode/collection/')
    remotes = {x['name']: x for x in resp['results']}
    community_remote_config = {
        'name': 'community',
        'url': 'https://old-galaxy.distronode.com/',
    ...
    # start the sync
    resp = api_client.request('/api/pulp/api/v3/repositories/distronode/distronode/')
    ...
    check_url = (
        '/api/v3/plugin/distronode/content/community/collections/'
