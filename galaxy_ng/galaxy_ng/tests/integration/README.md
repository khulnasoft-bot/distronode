...
# Test Data
* Test data is defined in [galaxy_ng/dev/common/setup_test_data.py](https://github.com/distronode/distronode/tree/devel/galaxy_ng/blob/master/dev/common/setup_test_data.py) and includes namespaces, users, tokens, and groups
...
# User Profiles
* User profiles are defined in [galaxy_ng/tests/integration/conftest.py](https://github.com/distronode/distronode/tree/devel/galaxy_ng/blob/master/galaxy_ng/tests/integration/conftest.py)
