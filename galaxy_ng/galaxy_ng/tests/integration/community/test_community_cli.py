...
def test_import_role_as_owner_no_tags(distronode_config):
    ...
    cfg = distronode_config(github_user)
    ...
    # https://github.com/distronode/distronode/issues/78516
...
@pytest.mark.deployment_community
def test_import_role_as_not_owner_no_tags(distronode_config):
    ...
    cfg = distronode_config(importer)
    client = SocialGithubClient(config=cfg)
    client.login()
    token = client.get_hub_token()
    import_pid = distronode_galaxy(
...
@pytest.mark.deployment_community
def test_import_role_fields_no_tags(distronode_config):
    ...
    config = distronode_config(github_user)
...
@pytest.mark.deployment_community
def test_delete_role_as_not_owner(distronode_config):
    ...
    cleanup_social_user(deleter, distronode_config)
...
@pytest.mark.deployment_community
def test_delete_namespace_deletes_roles(distronode_config):
...
@pytest.mark.deployment_community
def test_delete_role_with_cli(distronode_config):
...
@pytest.mark.deployment_community
def test_delete_missing_role_with_cli(distronode_config):
