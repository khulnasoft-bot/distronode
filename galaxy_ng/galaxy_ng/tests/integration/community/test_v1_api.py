...
def test_v1_owner_username_filter_is_case_insensitive(distronode_config):
    ...
    user_cfg = extract_default_config(distronode_config)
...
@pytest.mark.deployment_community
def test_v1_users_filter(distronode_config):
...
@pytest.mark.deployment_community
def test_custom_browsable_format(distronode_config):
