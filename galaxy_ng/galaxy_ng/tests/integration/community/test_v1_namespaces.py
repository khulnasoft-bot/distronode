...
def test_social_auth_creates_v3_namespace_as_v1_provider(distronode_config):
    ...
    with SocialGithubClient(config=cfg) as client:
        ...
        # PUT https://galaxy-dev.distronode.com/api/_ui/v1/my-namespaces/jctannertest/
...
@pytest.mark.deployment_community
def test_v1_namespace_provider_filter(distronode_config, galaxy_client):
