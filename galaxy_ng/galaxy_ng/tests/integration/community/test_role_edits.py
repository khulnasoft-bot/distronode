...
def test_community_legacy_role_edit(distronode_config):
    ...
    cleanup_social_user(namespace_v3name, distronode_config)
    cleanup_social_user(namespace_v1name, distronode_config)
