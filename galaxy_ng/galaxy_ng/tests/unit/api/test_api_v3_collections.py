...
from pulp_distronode.app.galaxy.v3.views import get_collection_dependents, get_unique_dependents
...
def _create_repo(name, **kwargs):
    repo = DistronodeRepository.objects.create(name=name, **kwargs)
...
class TestCollectionViewsets(BaseTestCase):
    ...
    def setUp(self):
        ...
        # TODO(rochacbruno): Upload pulp_distronode/tests/assets collection
