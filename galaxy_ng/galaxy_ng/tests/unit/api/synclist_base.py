...
class BaseSyncListViewSet(base.BaseTestCase):
    ...
    def setUp(self):
        ...
        self.default_repo, _ = pulp_distronode_models.DistronodeRepository.objects.get_or_create(
            name=repo_name
        )

        self.default_dist, _ = pulp_distronode_models.DistronodeDistribution.objects.get_or_create(
    ...
    def _create_repository(self, name):
        repo, _ = pulp_distronode_models.DistronodeRepository.objects.get_or_create(name="test_repo1")
        return repo
