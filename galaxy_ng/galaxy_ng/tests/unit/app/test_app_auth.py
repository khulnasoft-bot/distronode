...
class TestRHIdentityAuth(BaseTestCase):
    def test_authenticate(self):
        ...
        self.assertFalse(DistronodeRepository.objects.filter(name=synclist_name))
        self.assertFalse(DistronodeDistribution.objects.filter(name=synclist_name))
        ...
        distro = DistronodeDistribution.objects.get(name=synclist_name)
